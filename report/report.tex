...
\end{subfigure}
\caption{Here, the error between the numerical solution and approximation shrinks as the interaction parameter increases which corresponds to increment in interaction energy.}
\end{figure}
