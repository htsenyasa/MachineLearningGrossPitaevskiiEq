...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
		...
		\label{fig:d}
    \end{subfigure}
    \caption{Here histograms represents total energy distributions for different interaction parameter values.}
...
Accuracy of the CNN is higher than FFN in first 20 epochs. In (a) there is no bias as in Fig.~\ref{fig:FFN-g-0}
