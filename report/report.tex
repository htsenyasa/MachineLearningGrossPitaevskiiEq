...
If we plug Eq.~\eqref{eq:thomas_fermi_mu_bound} the equations reads,

\begin{equation}
    \frac{m\omega^2 z_{TF}^3}{g} - \frac{m\omega^2 z_{TF}^3}{3g} = N
\end{equation}
...
\end{subfigure}
\caption{Here, the error between the numerical solution and approximation shrinks as the interaction parameter increases which corresponds to increament in interaction energy.}
\end{figure}
...
%\end{subfigure}
%\begin{subfigure}[t]{0.45\textwidth}
%    \includegraphics[width=\linewidth]{randomafterproc}
%\end{subfigure}
\end{figure}
