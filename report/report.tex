...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{solutionswithinter}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.5\linewidth]{sol-comp}
...
\textbf{As shown in Fig~\ref{fig:comp_thomas_num}d, the interaction parameter is great enough to use Thomas-Fermi approximation but since the density is determined by the Eq~\eqref{eq:thomas_fermi_mu_integral} the characteristic must be same with the potential used. This situation can be seen vividly in Fig~\ref{fig:comp_thomas_num}c at near zero region.}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.5\linewidth]{comparison-energy}
