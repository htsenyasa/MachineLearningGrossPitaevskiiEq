...
class GaussianSolirteRandomVariable(GaussianRandomVariable):
    ...
    def makeFixedVarianceNoises(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 30, col 1.
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 30, col 84.
        write('''), _vector_size);
...
for (long _i0 = 0; _i0 < _vector_size; _i0++)
  reinterpret_cast<real*>(_active_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 34, col 35.
        write(''')[_i0] *= _sigma;
''')
        # 
