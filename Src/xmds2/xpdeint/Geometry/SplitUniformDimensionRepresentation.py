...
class SplitUniformDimensionRepresentation(_SplitUniformDimensionRepresentation):
    ...
    def defines(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 31, col 9.
        write('''        (2.0*M_PI/(''')
        _v = VFFSL(SL,"_range",True) # u'$_range' on line 31, col 39
        if _v is not None: write(_filter(_v, rawExpr='$_range')) # from line 31, col 39.
        write('''))
#define ''')
        _v = VFFSL(SL,"minimum",True) # u'${minimum}' on line 32, col 9
        if _v is not None: write(_filter(_v, rawExpr='${minimum}')) # from line 32, col 9.
        write('''     (-(''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 32, col 27
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 32, col 27.
        write('''/2) * ''')
        _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 32, col 49
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 32, col 49.
        write(''')
#define ''')
        _v = VFFSL(SL,"maximum",True) # u'${maximum}' on line 33, col 9
        if _v is not None: write(_filter(_v, rawExpr='${maximum}')) # from line 33, col 9.
        write('''     ((''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 33, col 26
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 33, col 26.
        write(''' - 1)/2 * ''')
        _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 33, col 52
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 33, col 52.
        write(''')
''')
        # 
...
for (long ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${alternateLoopIndex}')) # from line 59, col 11.
        write(''' = -(''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 59, col 37
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 59, col 37.
        write('''/2); ''')
        _v = VFFSL(SL,"alternateLoopIndex",True) # u'${alternateLoopIndex}' on line 59, col 58
        if _v is not None: write(_filter(_v, rawExpr='${alternateLoopIndex}')) # from line 59, col 58.
        write(''' < (''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 59, col 83
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 59, col 83.
        write(''' + 1)/2; ''')
        _v = VFFSL(SL,"alternateLoopIndex",True) # u'${alternateLoopIndex}' on line 59, col 108
        if _v is not None: write(_filter(_v, rawExpr='${alternateLoopIndex}')) # from line 59, col 108.
        write('''++) {
  long ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 60, col 8
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 60, col 8.
        write(''' = ''')
        _v = VFFSL(SL,"alternateLoopIndex",True) # u'${alternateLoopIndex}' on line 60, col 23
        if _v is not None: write(_filter(_v, rawExpr='${alternateLoopIndex}')) # from line 60, col 23.
        write(''';
  if (''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 61, col 7
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 61, col 7.
        write(''' < 0)
    ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 62, col 5
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 62, col 5.
        write(''' += ''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 62, col 21
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 62, col 21.
        write(''';
''')
        # 
...
#undef ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 69, col 8.
        write('''
#undef d''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 70, col 9
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 70, col 9.
        write('''
''')
        # 
    ...
    def localIndexFromIndexForDimensionRep(self, dimRep, **KWS):
        ...
        assert isinstance(VFFSL(SL,"runtimeLattice",True), str) or isinstance(dimRep.runtimeLattice, str) or VFFSL(SL,"runtimeLattice",True) >= dimRep.runtimeLattice
        # 
        _v = VFFSL(SL,"dimRep.loopIndex",True) # u'${dimRep.loopIndex}' on line 80, col 1
        if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 80, col 1.
        write(''' + ''')
        _v = VFFSL(SL,"dimRep.localOffset",True) # u'${dimRep.localOffset}' on line 80, col 23
        if _v is not None: write(_filter(_v, rawExpr='${dimRep.localOffset}')) # from line 80, col 23.
        write(''' - ''')
        _v = VFFSL(SL,"localOffset",True) # u'${localOffset}' on line 80, col 47
        if _v is not None: write(_filter(_v, rawExpr='${localOffset}')) # from line 80, col 47.
        write(''' + (signbit(''')
        _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 80, col 73
        if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 80, col 73.
        write(''') ? (''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 80, col 92
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 80, col 92.
        write(''' - ''')
        _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 80, col 111
        if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 80, col 111.
        write(''') : 0)''')
        # 
    ...
    def strictlyAscendingGlobalIndex(self, **KWS):
        ...
        if not VFFSL(SL,"hasLocalOffset",True): # generated from line 86, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 87, col 1.
            write(''' + (signbit(''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 87, col 25
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 87, col 25.
            write(''') ? -(''')
            _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 87, col 38
            if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 87, col 38.
            write('''+1)/2 : ''')
            _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 87, col 62
            if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 87, col 62.
            write('''/2)''')
        else: # generated from line 88, col 3
            write('''lround(''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 89, col 8
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 89, col 8.
            write('''/''')
            _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 89, col 16
            if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 89, col 16.
            write(''') + ''')
            _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 89, col 31
            if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 89, col 31.
            write('''/2''')
        # 
    ...
    def createCoordinateVariableForSinglePointSample(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 104, col 1.
        write(''' ''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 104, col 9
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 104, col 9.
        write(''' = 0.0;
#define d''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 105, col 10
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 105, col 10.
        write(''' (''')
        _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 105, col 19
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 105, col 19.
        write(''' * (''')
        _v = VFFSL(SL,"volumePrefactor",True) # u'${volumePrefactor}' on line 105, col 34
        if _v is not None: write(_filter(_v, rawExpr='${volumePrefactor}')) # from line 105, col 34.
        write('''))
''')
        # 
    ...
    def initialiseArray(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 111, col 11.
        write(''' = 0; ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 111, col 29
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 111, col 29.
        write(''' < (''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 111, col 45
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 111, col 45.
        write('''+1)/2; ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 111, col 68
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 111, col 68.
        write('''++)
  ''')
        _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 112, col 3
        if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 112, col 3.
        write('''[''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 112, col 16
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 112, col 16.
        write('''] = ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 112, col 32
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 112, col 32.
        write('''*''')
        _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 112, col 45
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 112, col 45.
        write(''';
for (long ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 113, col 27.
        write('''+1)/2; ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 113, col 50
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 113, col 50.
        write(''' < ''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 113, col 65
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 113, col 65.
        write('''; ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 113, col 83
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 113, col 83.
        write('''++)
  ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 114, col 34.
        write(''' - ''')
        _v = VFFSL(SL,"loopIndex",True) # u'${loopIndex}' on line 114, col 53
        if _v is not None: write(_filter(_v, rawExpr='${loopIndex}')) # from line 114, col 53.
        write(''') * ''')
        _v = VFFSL(SL,"stepSize",True) # u'${stepSize}' on line 114, col 69
        if _v is not None: write(_filter(_v, rawExpr='${stepSize}')) # from line 114, col 69.
        write(''';
''')
        # 
