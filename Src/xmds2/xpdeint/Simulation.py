...
#define _LOG_LEVELS_BEING_LOGGED (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${features['Driver'].logLevelsBeingLogged}")) # from line 47, col 35.
        write(''')
...
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('logFunctionBegin', $featureOrdering, $dict), autoIndent=True}")) # from line 65, col 7.
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${logFunctionInnerContent, autoIndent=True, extraIndent=extraIndent}')) # from line 67, col 7.
        write('''      ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('logFunctionEnd', $featureOrdering, $dict), autoIndent=True}")) # from line 68, col 7.
...
""")
        for child in VFFSL(SL,"children",True): # generated from line 102, col 1
            ...
            if VFFSL(SL,"result",True) and not VFN(VFFSL(SL,"result",True),"isspace",False)(): # generated from line 105, col 3
                ...
                if _v is not None: write(_filter(_v, rawExpr='${result}')) # from line 106, col 1.
                write('''
''')
        write('''
''')
...
typedef ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${realType}')) # from line 113, col 9.
        write(""" real;
...
//   ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$child.description')) # from line 143, col 6.
                write(''' defines
''')
                _v = VFFSL(SL,"result",True) # u'$result' on line 144, col 1
                if _v is not None: write(_filter(_v, rawExpr='$result')) # from line 144, col 1.
        write('''
...
//   ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$child.description')) # from line 160, col 6.
                write(''' globals
''')
                _v = VFFSL(SL,"result",True) # u'$result' on line 161, col 1
                if _v is not None: write(_filter(_v, rawExpr='$result')) # from line 161, col 1.
        write('''
...
//   ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$child.description')) # from line 176, col 6.
                write(''' function prototypes
''')
                _v = VFFSL(SL,"result",True) # u'$result' on line 177, col 1
                if _v is not None: write(_filter(_v, rawExpr='$result')) # from line 177, col 1.
        write('''
// ********************************************************
// MAIN ROUTINE
// ********************************************************
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$features.Driver.mainRoutine')) # from line 184, col 1.
        write('''
// ********************************************************
...
//   ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$child.description')) # from line 205, col 6.
                write(''' function implementations
''')
                _v = VFFSL(SL,"result",True) # u'$result' on line 206, col 1
                if _v is not None: write(_filter(_v, rawExpr='$result')) # from line 206, col 1.
        write('''
''')
