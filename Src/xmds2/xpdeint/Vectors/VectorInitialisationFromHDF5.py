...

{
  ...
  bzero(_active_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 43, col 17.
        write(''', sizeof(''')
        _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 43, col 38
        if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 43, col 38.
        write(''') * ''')
        _v = VFFSL(SL,"vector.allocSize",True) # u'${vector.allocSize}' on line 43, col 56
        if _v is not None: write(_filter(_v, rawExpr='${vector.allocSize}')) # from line 43, col 56.
        write(''');
''')
...
''')
  ...
  ''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${initialisationCodeBlock.loop(self.insideInitialisationLoops, vectorOverrides=vectorOverrides), autoIndent=True}')) # from line 52, col 3.
        write('''}

htri_t result;
hid_t hdf5_file = H5Fopen("''')
        _v = VFFSL(SL,"filename",True) # u'${filename}' on line 57, col 28
        if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 57, col 28.
...
if (hdf5_file < 0) {
  _LOG(_ERROR_LOG_LEVEL, "Unable to open input HDF5 file \'''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 59, col 59.
        write('''\'. Does it exist?\\n");
}
hid_t hdf5_parent = 0;
''')
        if VFFSL(SL,"groupName",True): # generated from line 62, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 63, col 37.
            write('''", H5P_DEFAULT)) > 0) {
  hdf5_parent = H5Gopen(hdf5_file, "''')
            _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 64, col 37
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 64, col 37.
            write('''");
} else if (!result) {
  _LOG(_ERROR_LOG_LEVEL, "Unable to find group \'''')
            _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 66, col 49
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 66, col 49.
            write("""' in HDF5 file '""")
            _v = VFFSL(SL,"filename",True) # u'${filename}' on line 66, col 77
            if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 66, col 77.
            write('''\'.\\n");
} else {
  _LOG(_ERROR_LOG_LEVEL, "Unable to determine if group \'''')
            _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 68, col 57
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 68, col 57.
            write("""' exists in HDF5 file '""")
            _v = VFFSL(SL,"filename",True) # u'${filename}' on line 68, col 92
            if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 68, col 92.
...
''')
  ...
  _LOG(_ERROR_LOG_LEVEL, "Unable to determine if group \'/1\' exists in HDF5 file \'''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 76, col 82.
            write('''\'. Is the file corrupt?\\n");
}
''')
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${dimCount}')) # from line 81, col 19.
        write('''];
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.type}')) # from line 94, col 45.
            write('''*)xmds_malloc(file_dims[''')
            _v = VFFSL(SL,"dimNum",True) # u'${dimNum}' on line 94, col 83
            if _v is not None: write(_filter(_v, rawExpr='${dimNum}')) # from line 94, col 83.
            write('''] * sizeof(''')
            _v = VFFSL(SL,"dimRep.type",True) # u'${dimRep.type}' on line 94, col 103
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.type}')) # from line 94, col 103.
            write('''));
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$dataType')) # from line 96, col 33.
            write(''', H5S_ALL, H5S_ALL, H5P_DEFAULT, ''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 96, col 75
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 96, col 75.
            write('''_inputdata);
''')
            if isinstance(dimRep, SplitUniformDimensionRepresentation): # generated from line 97, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.type}')) # from line 99, col 1.
                write('''* ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 99, col 17
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 99, col 17.
                write(''' = (''')
                _v = VFFSL(SL,"dimRep.type",True) # u'${dimRep.type}' on line 99, col 36
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.type}')) # from line 99, col 36.
                write('''*)xmds_malloc(''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 99, col 64
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 99, col 64.
                write(''' * sizeof(''')
                _v = VFFSL(SL,"dimRep.type",True) # u'${dimRep.type}' on line 99, col 97
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.type}')) # from line 99, col 97.
                write('''));
for (long _i0 = 0; _i0 < ''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 100, col 26
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 100, col 26.
                write('''; _i0++) {
  ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 101, col 3
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 101, col 3.
                write('''[_i0] = ''')
                _v = VFFSL(SL,"dimRep.arrayName",True) # u'${dimRep.arrayName}' on line 101, col 26
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.arrayName}')) # from line 101, col 26.
                write('''[(_i0 + (''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 101, col 54
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 101, col 54.
                write('''+1)/2) % ''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 101, col 86
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 101, col 86.
                write('''];
}
''')
            ...
            if VFFSL(SL,"geometryMatchingMode",True) == 'strict' or isinstance(dimRep, NonUniformDimensionRepresentation): # generated from line 106, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 107, col 26.
                write('''-1; _i0++) {
  real step = ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 108, col 15
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 108, col 15.
                write('''[_i0+1] - ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 108, col 40
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 108, col 40.
                write('''[_i0];
  if (abs(''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 109, col 11
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 109, col 11.
                write('''[_i0] - ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 109, col 34
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 109, col 34.
    ...
    _LOG(_ERROR_LOG_LEVEL, "Geometry matching mode is strict for dimension \'''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 111, col 77.
                write('''\'.\\n"
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 113, col 60.
                write(''': %e, simulation_''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 113, col 91
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 113, col 91.
                write(''': %e, difference: %e\\n",
                           (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 114, col 34
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 114, col 34.
                write('''_inputdata[_i0], (real)''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 114, col 71
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 114, col 71.
                write('''[_i0], (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 114, col 99
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 114, col 99.
                write('''_inputdata[_i0] - ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 114, col 131
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 114, col 131.
                write('''[_i0]);
  }
}
''')
...
real ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 121, col 6.
                write('''_step = ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 121, col 28
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 121, col 28.
                write('''[1] - ''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 121, col 49
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 121, col 49.
                write('''[0];
real ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 122, col 6
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 122, col 6.
                write('''_inputdata_step = ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 122, col 38
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 122, col 38.
                write('''_inputdata[1] - ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 122, col 68
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 122, col 68.
                write('''_inputdata[0];
if (abs(''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 123, col 9
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 123, col 9.
                write('''_step - ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 123, col 31
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 123, col 31.
                write('''_inputdata_step) > 1e-3*''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 123, col 69
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 123, col 69.
                write('''_step) {
  // _LOG will cause the simulation to exit
  _LOG(_ERROR_LOG_LEVEL, "The step size in the \'''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 125, col 49
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 125, col 49.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 126, col 49.
                write('''\' dimension was %e, while the input data had step size %e.\\n",
                         (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 127, col 32
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 127, col 32.
                write('''_step, (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 127, col 59
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 127, col 59.
                write('''_inputdata_step);
}
// Check the input and simulation grids overlap
if ((''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 130, col 6
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 130, col 6.
                write('''[0] > ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 130, col 27
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 130, col 27.
                write('''_inputdata[file_dims[''')
                _v = VFFSL(SL,"dimNum",True) # u'${dimNum}' on line 130, col 62
                if _v is not None: write(_filter(_v, rawExpr='${dimNum}')) # from line 130, col 62.
                write(''']-1]) || (''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 130, col 81
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 130, col 81.
                write('''[''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 130, col 97
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 130, col 97.
                write('''-1] < ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 130, col 126
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 130, col 126.
                write('''_inputdata[0])) {
  // _LOG will cause the simulation to exit
  _LOG(_ERROR_LOG_LEVEL, "The input and simulation grids do not overlap!\\n"
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 134, col 32.
                write('''[0], (real)''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 134, col 58
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 134, col 58.
                write('''[''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 134, col 74
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 134, col 74.
                write('''-1],
                         (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 135, col 32
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 135, col 32.
                write('''_inputdata[0], (real)''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 135, col 67
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 135, col 67.
                write('''_inputdata[file_dims[''')
                _v = VFFSL(SL,"dimNum",True) # u'${dimNum}' on line 135, col 102
                if _v is not None: write(_filter(_v, rawExpr='${dimNum}')) # from line 135, col 102.
                write(''']-1]);
}
real ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 137, col 6
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 137, col 6.
                write('''_fileOffsetR = (''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 137, col 36
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 137, col 36.
                write('''_inputdata[0]-''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 137, col 64
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 137, col 64.
                write('''[0])/''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 137, col 84
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 137, col 84.
                write('''_step;
if (remainder(''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 138, col 15
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 138, col 15.
                write('''_inputdata[0]-''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 138, col 43
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 138, col 43.
                write('''[0], ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 138, col 63
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 138, col 63.
                write('''_step) > 0.01*''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 138, col 91
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 138, col 91.
                write('''_step) {
  _LOG(_ERROR_LOG_LEVEL, "The input and simulation grids do not overlap sufficiently!\\n"
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 140, col 101.
                write('''\' dimension is %f, and it should be integral!\\n",
                         (''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 141, col 27
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 141, col 27.
                write('''_inputdata[0]-''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 141, col 55
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 141, col 55.
                write('''[0])/''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 141, col 75
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 141, col 75.
                write('''_step);
}
long ''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 143, col 6
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 143, col 6.
                write('''_fileOffset = lround((''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 143, col 42
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 143, col 42.
                write('''_inputdata[0]-''')
                _v = VFFSL(SL,"dimArrayName",True) # u'${dimArrayName}' on line 143, col 70
                if _v is not None: write(_filter(_v, rawExpr='${dimArrayName}')) # from line 143, col 70.
                write('''[0])/''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 143, col 90
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 143, col 90.
                write('''_step);
''')
...
file_dataspace = H5Screate_simple(''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${len(field.dimensions)}')) # from line 151, col 35.
...
''')
            for offset, componentName in VFFSL(SL,"variable.separatedComponents",True): # generated from line 163, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 164, col 15.
                write(''' = 0;
if ((result = H5Lexists(hdf5_parent, "''')
                _v = VFFSL(SL,"componentName",True) # u'${componentName}' on line 165, col 39
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 165, col 39.
                write('''", H5P_DEFAULT))>0) {
  dataset_''')
                _v = VFFSL(SL,"componentName",True) # u'${componentName}' on line 166, col 11
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 166, col 11.
                write(''' = H5Dopen(hdf5_parent, "''')
                _v = VFFSL(SL,"componentName",True) # u'${componentName}' on line 166, col 52
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 166, col 52.
                write('''");
  ...
  _LOG(_WARNING_LOG_LEVEL, "Warning: Unable to find variable name \'''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 169, col 68.
                write('''\' in HDF5 file.\\n");
else
  _LOG(_WARNING_LOG_LEVEL, "Warning: Unable to determine if variable \'''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 171, col 71.
                write('''\' exists in HDF5 file. Is the file corrupt?\\n");
''')
        write('''
if (!_variablesFound) {
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${processData(processingDict)}')) # from line 180, col 1.
        write('''
...
''')
        for variable in variables: # generated from line 183, col 3
            for offset, componentName in VFFSL(SL,"variable.separatedComponents",True): # generated from line 184, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 185, col 13.
                write(''') H5Dclose(dataset_''')
                _v = VFFSL(SL,"componentName",True) # u'${componentName}' on line 185, col 48
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 185, col 48.
                write(''');
''')
...
''')
        for dim in VFFSL(SL,"vector.field.dimensions",True): # generated from line 190, col 3
            ...
            if isinstance(dimRep, SplitUniformDimensionRepresentation): # generated from line 192, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 193, col 11.
                write('''_data);
''')
            write('''xmds_free(''')
...
H5Sclose(dataspace_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 196, col 20.
            write(''');
H5Dclose(dataset_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 197, col 18
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 197, col 18.
            write(''');
''')
...
#define """)
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 213, col 9.
        write(''' Dont_use_propagation_dimension_''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 213, col 64
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 213, col 64.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${codeString}')) # from line 216, col 1.
        write('''// **********************************************
#undef ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 218, col 8
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 218, col 8.
        write('''
''')
        # 
