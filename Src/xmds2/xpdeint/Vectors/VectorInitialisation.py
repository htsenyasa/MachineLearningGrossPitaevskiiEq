...
class VectorInitialisation(ScriptElement):
    ...
    def description(self, **KWS):
        ...
        write('''Vector initialisation to zero''')
    ...
    def initialiseVector(self, **KWS):
        ...
        write('''bzero(_active_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 40, col 15
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 40, col 15.
        write(''', sizeof(''')
        _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 40, col 36
        if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 40, col 36.
        write(''') * ''')
        _v = VFFSL(SL,"vector.allocSize",True) # u'${vector.allocSize}' on line 40, col 54
        if _v is not None: write(_filter(_v, rawExpr='${vector.allocSize}')) # from line 40, col 54.
        write(''');
''')
