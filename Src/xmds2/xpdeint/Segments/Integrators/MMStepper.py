...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 40, col 1.
        write('''
if (_istep == 0) 
{
  // a_k = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors($integrationVectors, '_akfield'), autoIndent=True}")) # from line 45, col 3.
        write('''  
  // active vector = a_i
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_aifield'), autoIndent=True}")) # from line 48, col 3.
        write('''  
  // a_i = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors($integrationVectors, '_aifield'), autoIndent=True}")) # from line 51, col 3.
        write('''  
  // a_i = G[a_i, t]
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('deltaA', arguments, parentFunction = function), autoIndent=True}")) # from line 54, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 57, col 3.
        write('''  
  // active vector = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active'), autoIndent=True}")) # from line 60, col 3.
        write('''  
  // a = a + G[a_i, t]
  ''')
...
""", basis = VFFSL(SL,"homeBasis",True))
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('nonconstantIPFields', arguments, _exponent = 1, _arrayIndex = 0, parentFunction = function), autoIndent=True}")) # from line 67, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIdent=True, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function), autoIdent=True}")) # from line 70, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 73, col 3.
        write('''  
  ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 75, col 3
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 75, col 3.
        write(''' += _step;
...
else 
{
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_akfield'), autoIndent=True}")) # from line 81, col 3.
        write('''  
  // ipEvolve a_k +1
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function), autoIndent=True}")) # from line 84, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 87, col 3.
        write('''  
  // active vector = a_i
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_aifield'), autoIndent=True}")) # from line 90, col 3.
        write('''  
  // a_i = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors($integrationVectors, '_aifield'), autoIndent=True}")) # from line 93, col 3.
        write('''  
  // a_i = G[a_i, t]
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('deltaA', arguments, parentFunction = function), autoIndent=True}")) # from line 96, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 99, col 3.
        write('''  
  // active vector = a_k
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_akfield'), autoIndent=True}")) # from line 102, col 3.
        write('''  
  // a_k = a_k + 2*a_i
  ''')
        _v = VFFSL(SL,"loopOverVectorsWithInnerContentTemplate",False)(VFFSL(SL,"integrationVectors",True), 
...
""", basis = VFFSL(SL,"homeBasis",True))
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('nonconstantIPFields', arguments, _exponent = 1, _arrayIndex = 0, parentFunction = function), autoIndent=True}")) # from line 109, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function), autoIndent=True}")) # from line 112, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 115, col 3.
        write('''  
  // a = a_k, a_k = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${swapVectorPointers($integrationVectors, '_akfield'), autoIndent=True}")) # from line 118, col 3.
        write('''  
  ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 120, col 3
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 120, col 3.
        write(''' += _step;
...
if (_istep == (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="$getVar('integrator.maxIntegrationStepsVar', $integrator.stepCount)")) # from line 124, col 16.
        write(''' - 1)) {
  // active vector = a_k
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_akfield'), autoIndent=True}")) # from line 126, col 3.
        write('''  
  // ipEvolve a_k +1
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function), autoIndent=True}")) # from line 129, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 132, col 3.
        write('''  
  // active vector = a_i
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${assignVectorPointers($integrationVectors, '_active', '_aifield'), autoIndent=True}")) # from line 135, col 3.
        write('''  
  // a_i = a
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors($integrationVectors, '_aifield'), autoIndent=True}")) # from line 138, col 3.
        write('''  
  // a_i = G[a_i, t]
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${callFunction('deltaA', arguments, parentFunction = function), autoIndent=True}")) # from line 141, col 3.
        write('''
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis), autoIndent=True}')) # from line 144, col 3.
        write('''  
  // a = 0.5*(a + a_k + G[a_i, t])
  ''')
        _v = VFFSL(SL,"loopOverVectorsWithInnerContentTemplate",False)(VFFSL(SL,"integrationVectors",True), 
...
""", basis = VFFSL(SL,"homeBasis",True))
  ...
  if ((''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="$getVar('integrator.maxIntegrationStepsVar', $integrator.stepCount)")) # from line 151, col 8.
        write(''' % 2) == 0) {
    ...
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${swapVectorPointers($integrationVectors, '_akfield'), autoIndent=True}")) # from line 154, col 5.
        write('''    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors($integrationVectors, None, '_akfield'), autoIndent=True}")) # from line 155, col 5.
        write('''  }
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${assignVectorPointers($integrationVectors, '_active')}")) # from line 161, col 1.
        write('''
// End of single step
''')
        # 
