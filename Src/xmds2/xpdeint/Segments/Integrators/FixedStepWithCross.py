...
class FixedStepWithCross(_FixedStepWithCross):
    ...
    def leftRightDeltaAFunctionBody(self, function, replacementOperatorContainer, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${evaluateComputedVectors($dynamicVectorsNeedingPrecalculationForOperatorContainers($intraStepOperatorContainers), static = False)}')) # from line 27, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluatePreDeltaAOperators(parentFunction = function)}')) # from line 34, col 1.
        # 
...
''')
            if not operatorContainer == VFFSL(SL,"operatorContainerToOverride",True): # generated from line 43, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluateDeltaAOperator(parentFunction = function)}')) # from line 44, col 1.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${replacementOperatorContainer.evaluateDeltaAOperator(parentFunction = function)}')) # from line 46, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluatePostDeltaAOperators(parentFunction = function)}')) # from line 56, col 1.
        # 
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis($integrationVectorsNeedingUpdating, $homeBasis), autoIndent=True}')) # from line 62, col 1.
        write('''
''')
