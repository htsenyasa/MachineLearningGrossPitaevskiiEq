...
class Integrator(_Integrator):
    ...
    def description(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$segmentNumber')) # from line 25, col 27.
        write(''' (''')
        _v = VFFSL(SL,"stepper.name",True) # u'$stepper.name' on line 25, col 43
        if _v is not None: write(_filter(_v, rawExpr='$stepper.name')) # from line 25, col 43.
        write(''' Integrator)''')
    ...
    def globals(self, **KWS):
        ...
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 31, col 3
            ...
            for arrayName in VFFSL(SL,"extraIntegrationArrayNames",True): # generated from line 33, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 34, col 1.
                write('''* _''')
                _v = VFFSL(SL,"name",True) # u'${name}' on line 34, col 18
                if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 34, col 18.
                write('''_''')
                _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 34, col 26
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 34, col 26.
                write('''_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 34, col 39
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 34, col 39.
                write(''';
''')
        # 
    ...
    def deltaAFunctionBody(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${evaluateComputedVectors($dynamicVectorsNeedingPrecalculationForOperatorContainers($intraStepOperatorContainers), static = False)}')) # from line 43, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluatePreDeltaAOperators(parentFunction = function)}')) # from line 50, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluateDeltaAOperator(parentFunction = function)}')) # from line 59, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluatePostDeltaAOperators(parentFunction = function)}')) # from line 68, col 1.
        # 
    ...
    def preSingleStep(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${evaluateComputedVectors($dynamicVectorsNeedingPrecalculationForOperatorContainers($stepStartOperatorContainers))}')) # from line 75, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${operatorContainer.evaluateOperators(_step = '_step')}")) # from line 79, col 1.
        # 
    ...
    def postSingleStep(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('postSingleStep', featureOrdering)}")) # from line 88, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr='${evaluateComputedVectors($dynamicVectorsNeedingPrecalculationForOperatorContainers($stepEndOperatorContainers))}')) # from line 90, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${operatorContainer.evaluateOperators(_step = '_step')}")) # from line 94, col 1.
        # 
    ...
    def allocate(self, **KWS):
        ...
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 112, col 3
            ...
            for arrayName in VFFSL(SL,"extraIntegrationArrayNames",True): # generated from line 114, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 115, col 2.
                write('''_''')
                _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 115, col 10
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 115, col 10.
                write('''_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 115, col 23
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 115, col 23.
                write(''' = ''')
                write('''(''')
                _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 116, col 2
                if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 116, col 2.
                write('''*) xmds_malloc(sizeof(''')
                _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 116, col 38
                if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 116, col 38.
                write(''') * MAX(''')
                _v = VFFSL(SL,"vector.allocSize",True) # u'${vector.allocSize}' on line 116, col 60
                if _v is not None: write(_filter(_v, rawExpr='${vector.allocSize}')) # from line 116, col 60.
                write(''',1));
''')
        # 
    ...
    def free(self, **KWS):
        ...
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 127, col 3
            for arrayName in VFFSL(SL,"extraIntegrationArrayNames",True): # generated from line 128, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 129, col 12.
                write('''_''')
                _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 129, col 20
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 129, col 20.
                write('''_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 129, col 33
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 129, col 33.
                write(''');
''')
        # 
    ...
    def localInitialise(self, **KWS):
        ...
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 141, col 3
            ...
            for arrayName in VFFSL(SL,"extraIntegrationArrayNames",True): # generated from line 143, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 144, col 1.
                write('''* _''')
                _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 144, col 18
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 144, col 18.
                write('''_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 144, col 31
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 144, col 31.
                write(''' = _''')
                _v = VFFSL(SL,"name",True) # u'${name}' on line 144, col 47
                if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 144, col 47.
                write('''_''')
                _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 144, col 55
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 144, col 55.
                write('''_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 144, col 68
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 144, col 68.
                write(''';
''')
        write('''
''')
        _v = VFFSL(SL,"stepper.localInitialise",True) # u'${stepper.localInitialise}' on line 148, col 1
        if _v is not None: write(_filter(_v, rawExpr='${stepper.localInitialise}')) # from line 148, col 1.
        # 
    ...
    def localFinalise(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 158, col 9.
        write('''_END:;
''')
        _v = VFFSL(SL,"stepper.localFinalise",True) # u'${stepper.localFinalise}' on line 159, col 1
        if _v is not None: write(_filter(_v, rawExpr='${stepper.localFinalise}')) # from line 159, col 1.
        # 
    ...
    def earlyTerminationCode(self, **KWS):
        ...
        for mg, sampleCount in zip(VFFSL(SL,"momentGroups",True), VFFSL(SL,"samples",True)): # generated from line 169, col 3
            if not VFFSL(SL,"sampleCount",True): # generated from line 170, col 5
                continue
            # 
            for dim in [x for x in mg.outputField.dimensions if not x.transverse]: # generated from line 174, col 5
                dimRep = dim.inBasis(mg.outputBasis)
                write('''if (''')
                _v = VFFSL(SL,"dimRep.prefix",True) # u'${dimRep.prefix}' on line 176, col 5
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.prefix}')) # from line 176, col 5.
                write('''_index_''')
                _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 176, col 28
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 176, col 28.
                write(''' < ''')
                _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 176, col 45
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 176, col 45.
                write(''')
  _''')
                _v = VFFSL(SL,"mg.name",True) # u'${mg.name}' on line 177, col 4
                if _v is not None: write(_filter(_v, rawExpr='${mg.name}')) # from line 177, col 4.
                write('''_sample();
''')
        write('''
goto _SEGMENT''')
        _v = VFFSL(SL,"segmentNumber",True) # u'${segmentNumber}' on line 181, col 14
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 181, col 14.
        write('''_END;
''')
        # 
