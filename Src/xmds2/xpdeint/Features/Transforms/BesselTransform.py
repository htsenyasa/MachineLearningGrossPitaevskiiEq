...
class BesselTransform(_BesselTransform):
    ...
    def globalsForDim(self, dimName, basisDict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${wrapArray($besselJZeros(besselOrder, lattice))}')) # from line 28, col 42.
        write('''};
const real _besseljS_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${besselJZeros(besselOrder, lattice+1)[-1]}')) # from line 29, col 35.
        write(''';
''')
        # 
