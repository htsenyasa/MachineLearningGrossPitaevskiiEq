...
class BesselBasis(Basis):
    ...
    def transformMatricesForDimRepsAtIndices(self, forwardDimRep, backwardDimRep, forwardIndex, backwardIndex, **KWS):
        ...
        _v = VFN(VFFSL(SL,"forwardDimRep",True),"besselJFunctionCall",False)(VFFSL(SL,"order",True), ''.join(['_besseljzeros_',str(VFFSL(SL,"forwardDimRep.parent.name",True)),'[',str(VFFSL(SL,"forwardIndex",True)),'] * _besseljzeros_',str(VFFSL(SL,"forwardDimRep.parent.name",True)),'[',str(VFFSL(SL,"backwardIndex",True)),'] / _besseljS_',str(VFFSL(SL,"forwardDimRep.parent.name",True))])) # u"${forwardDimRep.besselJFunctionCall($order, c'_besseljzeros_${forwardDimRep.parent.name}[${forwardIndex}] * _besseljzeros_${forwardDimRep.parent.name}[${backwardIndex}] / _besseljS_${forwardDimRep.parent.name}')}" on line 29, col 27
        if _v is not None: write(_filter(_v, rawExpr="${forwardDimRep.besselJFunctionCall($order, c'_besseljzeros_${forwardDimRep.parent.name}[${forwardIndex}] * _besseljzeros_${forwardDimRep.parent.name}[${backwardIndex}] / _besseljS_${forwardDimRep.parent.name}')}")) # from line 29, col 27.
        write(''';
''')
        # 
    ...
    def forwardMatrixForDimAtIndices(self, forwardDimRep, backwardDimRep, forwardIndex, backwardIndex, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${forwardDimRep.stepSizeArrayName}')) # from line 36, col 16.
        write('''[''')
        _v = VFFSL(SL,"forwardIndex",True) # u'$forwardIndex' on line 36, col 51
        if _v is not None: write(_filter(_v, rawExpr='$forwardIndex')) # from line 36, col 51.
        write(''']''')
    ...
    def backwardMatrixForDimAtIndices(self, forwardDimRep, backwardDimRep, forwardIndex, backwardIndex, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${backwardDimRep.stepSizeArrayName}')) # from line 40, col 16.
        write('''[''')
        _v = VFFSL(SL,"backwardIndex",True) # u'$backwardIndex' on line 40, col 52
        if _v is not None: write(_filter(_v, rawExpr='$backwardIndex')) # from line 40, col 52.
        write(''']''')
