...
class Diagnostics(_Diagnostics):
    ...
    def timestepErrorBegin(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 38, col 25.
        write('''_ncomponents];
for (long _i0 = 0; _i0 < _''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 39, col 27
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 39, col 27.
...
''')
    ...
    def timestepErrorEnd(self, dict, **KWS):
        ...
        # 
        _v = VFFSL(SL,"insertCodeForFeatures",False)('findMax', ['Driver'], {'variable': '_component_errors', 'count': ''.join(['_',str(VFFSL(SL,"vector.id",True)),'_ncomponents'])}) # u"${insertCodeForFeatures('findMax', ['Driver'], {'variable': '_component_errors', 'count': c'_${vector.id}_ncomponents'})}" on line 49, col 1
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('findMax', ['Driver'], {'variable': '_component_errors', 'count': c'_${vector.id}_ncomponents'})}")) # from line 49, col 1.
        write('''if (_error > ''')
        _v = VFFSL(SL,"integrator.tolerance",True) # u'$integrator.tolerance' on line 50, col 14
        if _v is not None: write(_filter(_v, rawExpr='$integrator.tolerance')) # from line 50, col 14.
        write(''')
''')
        if len(VFFSL(SL,"vector.field.dimensions",True)): # generated from line 51, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([componentName + '_error: %.1e (cutoff: %.1e)' for componentName in vector.components])}")) # from line 52, col 29.
            write('''\\n",
                           ''')
            _v = ', '.join([''.join(['_component_errors[',str(VFFSL(SL,"componentIndex",True)),'], _cutoff[',str(VFFSL(SL,"componentIndex",True)),']']) for componentIndex in range(len(vector.components))]) # u"${', '.join([c'_component_errors[${componentIndex}], _cutoff[${componentIndex}]' for componentIndex in range(len(vector.components))])}" on line 53, col 28
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([c'_component_errors[${componentIndex}], _cutoff[${componentIndex}]' for componentIndex in range(len(vector.components))])}")) # from line 53, col 28.
            write(''');
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([componentName + '_error: %.1e (size: %.1e)' for componentName in vector.components])}")) # from line 55, col 29.
            write('''\\n",
                           ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([c'_component_errors[${componentIndex}], mod(_active_${vector.id}[${componentIndex}])' for componentIndex in range(len(vector.components))])}")) # from line 56, col 28.
            write(''');
''')
        # 
...
''')
    ...
    def adaptiveStepFailed(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.tolerance}')) # from line 80, col 19.
        write(''')
  _LOG(_SEGMENT_LOG_LEVEL, "NaN hit on this step. Retrying. (Error set to %e)\\n", 2.0*''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.tolerance}')) # from line 81, col 87.
        write(''');
_LOG(_SEGMENT_LOG_LEVEL, "Step size %e failed, ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.propagationDimension}')) # from line 82, col 48.
        write(''' = %e, error = %e\\n", _step, ''')
        _v = VFFSL(SL,"integrator.propagationDimension",True) # u'${integrator.propagationDimension}' on line 82, col 111
        if _v is not None: write(_filter(_v, rawExpr='${integrator.propagationDimension}')) # from line 82, col 111.
        write(''', _error);
''')
        # 
    ...
    def nonlocalAccessValidationFunctionContents(self, dimRepsNeeded, nonlocalAccessString, componentName, func, **KWS):
        ...
        for dimRep in [dimRep for dimRep in dimRepsNeeded if dimRep.type == 'long' and isinstance(dimRep, UniformDimensionRepresentation)]: # generated from line 88, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 89, col 5.
            write(''' < 0 || ''')
            _v = VFFSL(SL,"dimRep.loopIndex",True) # u'${dimRep.loopIndex}' on line 89, col 32
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 89, col 32.
            write(''' >= ''')
            _v = VFFSL(SL,"dimRep.globalLattice",True) # u'${dimRep.globalLattice}' on line 89, col 55
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.globalLattice}')) # from line 89, col 55.
            write(''') {
  _LOG(
    _ERROR_LOG_LEVEL,
    "Error: Invalid access of dimension ''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 92, col 41
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 92, col 41.
    ...
    "       Error was caused by accessing variable \'''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 94, col 53.
            write('''\' nonlocally.\\n",
    filename, line_number, ''')
            _v = VFFSL(SL,"dimRep.loopIndex",True) # u'${dimRep.loopIndex}' on line 95, col 28
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 95, col 28.
            write(''' + ''')
            _v = VFFSL(SL,"dimRep.minimum",True) # u'${dimRep.minimum}' on line 95, col 50
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.minimum}')) # from line 95, col 50.
            write(''', ''')
            _v = VFFSL(SL,"dimRep.minimum",True) # u'${dimRep.minimum}' on line 95, col 69
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.minimum}')) # from line 95, col 69.
            write(''', ''')
            _v = VFFSL(SL,"dimRep.maximum",True) # u'${dimRep.maximum}' on line 95, col 88
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.maximum}')) # from line 95, col 88.
            write('''
  );
}
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${nonlocalAccessString}')) # from line 99, col 8.
        write(''';
''')
        # 
