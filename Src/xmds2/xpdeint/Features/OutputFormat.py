...
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('openXSILFile', featureOrdering), autoIndent=True}")) # from line 53, col 3.
        write('''  
...
void _close_xsil_file(FILE*& fp)
{
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('closeXSILFile', featureOrdering), autoIndent=True}")) # from line 71, col 3.
        write('''}

''')
        _v = VFFSL(SL,"writeXSILHeaderFunctionImplementation",True) # u'${writeXSILHeaderFunctionImplementation}' on line 74, col 1
        if _v is not None: write(_filter(_v, rawExpr='${writeXSILHeaderFunctionImplementation}')) # from line 74, col 1.
        write('''
''')
        _v = VFFSL(SL,"writeXSILFooterFunctionImplementation",True) # u'${writeXSILFooterFunctionImplementation}' on line 76, col 1
        if _v is not None: write(_filter(_v, rawExpr='${writeXSILFooterFunctionImplementation}')) # from line 76, col 1.
        # 
...
''')
        ...
        for line in VFN(VFFSL(SL,"xsilOutputHeader",True),"splitlines",False)(): # generated from line 92, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${line}')) # from line 93, col 16.
            write('''\\n");
''')
        write('''  
  fprintf(fp, "\\n<info>\\n");
  fprintf(fp, "Script compiled with XMDS2 version ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${xmds.versionString}')) # from line 97, col 51.
        write(''' (''')
        _v = VFFSL(SL,"xmds.subversionRevision",True) # u'${xmds.subversionRevision}' on line 97, col 74
        if _v is not None: write(_filter(_v, rawExpr='${xmds.subversionRevision}')) # from line 97, col 74.
        write(''')\\n");
...
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('xsilOutputInfo', $featureOrderingXSILInfo, {'fp': 'fp'}), autoIndent=True}")) # from line 102, col 3.
...
snprintf(_xsilFilename, 256, "%s.xsil", ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$filename')) # from line 123, col 41.
        write(''');
...
''')
        if not caller in VFFSL(SL,"outputFilesTruncated",True): # generated from line 129, col 3
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${truncateOutputFiles(filename), autoIndent=True}')) # from line 130, col 3.
...
''')
  ...
  fprintf(''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 166, col 11.
        write(''', "<XSIL Name=\\"''')
        _v = VFFSL(SL,"xsilElementName",True) # u'${xsilElementName}' on line 166, col 30
        if _v is not None: write(_filter(_v, rawExpr='${xsilElementName}')) # from line 166, col 30.
        write('''\\">\\n");
  fprintf(''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${numIndependentVariables}')) # from line 167, col 49.
        write('''</Param>\\n");
  fprintf(''')
  ...
  fprintf(''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${numIndependentVariables + componentCount}')) # from line 169, col 26.
        write('''</Dim>\\n");
  fprintf(''')
  ...
  fprintf(''')
        ...
        for dimension in VFFSL(SL,"field.dimensions",True): # generated from line 173, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimension.inBasis(basis).name}')) # from line 174, col 1.
            write(''' ''')
        # 
        ...
        for variable in VFFSL(SL,"dependentVariables",True): # generated from line 178, col 3
            for componentName in VFFSL(SL,"variable.components",True): # generated from line 179, col 5
                if VFFSL(SL,"variable.vector.type",True) == 'real': # generated from line 180, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 181, col 1.
                    write(''' ''')
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 183, col 19.
                    write('''I ''')
        write('''\\n");
  fprintf(''')
        _v = VFFSL(SL,"fp",True) # u'$fp' on line 188, col 11
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 188, col 11.
        write(''', "    </Stream>\\n");
  fprintf(''')
        _v = VFFSL(SL,"fp",True) # u'$fp' on line 189, col 11
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 189, col 11.
        write(''', "  </Array>\\n");
  fprintf(''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${precision}')) # from line 190, col 47.
        write('''\\">\\n");
''')
        # 
        ...
        for dimension in VFFSL(SL,"field.dimensions",True): # generated from line 193, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 194, col 11.
            write(''', "    <Dim>%i</Dim>\\n", ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$dimension.inBasis(basis).globalLattice')) # from line 194, col 39.
            write(''');
''')
        #  Now the variables dimension
        write('''  fprintf(''')
        _v = VFFSL(SL,"fp",True) # u'$fp' on line 197, col 11
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 197, col 11.
        write(''', "    <Dim>''')
        _v = VFFSL(SL,"numIndependentVariables",True) + componentCount # u'${numIndependentVariables + componentCount}' on line 197, col 26
        if _v is not None: write(_filter(_v, rawExpr='${numIndependentVariables + componentCount}')) # from line 197, col 26.
        write('''</Dim>\\n");
}
''')
        # 
    ...
    def writeOutFunctionImplementationEnd(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 206, col 5.
        write(''') {
  fprintf(''')
        _v = VFFSL(SL,"fp",True) # u'$fp' on line 207, col 11
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 207, col 11.
        write(''', "  </Array>\\n");
  fprintf(''')
        _v = VFFSL(SL,"fp",True) # u'$fp' on line 208, col 11
        if _v is not None: write(_filter(_v, rawExpr='$fp')) # from line 208, col 11.
        write(''', "</XSIL>\\n");
}
''')
        # 
