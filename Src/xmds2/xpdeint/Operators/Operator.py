...
class Operator(_Operator):
    ...
    def initialise(self, **KWS):
        ...
        if VFFSL(SL,"operatorVector",True): # generated from line 39, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${parent.id}')) # from line 40, col 2.
            write('''_calculate_''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 40, col 25
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 40, col 25.
            write('''_field();
''')
        # 
    ...
    def calculateOperatorFieldFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${codeBlocks['operatorDefinition'].loop(self.insideCalculateOperatorFieldLoops)}")) # from line 47, col 1.
        # 
    ...
    def insideCalculateOperatorFieldLoopsBegin(self, **KWS):
        ...
        for operatorComponentName in VFN(VFFSL(SL,"operatorComponents",True),"iterkeys",False)(): # generated from line 53, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${operatorVector.type}')) # from line 57, col 1.
            write(''' ''')
            _v = VFFSL(SL,"operatorComponentName",True) # u'$operatorComponentName' on line 57, col 24
            if _v is not None: write(_filter(_v, rawExpr='$operatorComponentName')) # from line 57, col 24.
            write(''';
''')
        # 
    ...
    def evaluateOperatorFunctionContents(self, function, **KWS):
        ...
        if not 'calculateOperatorField' in VFFSL(SL,"functions",True): # generated from line 66, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${evaluateOperatorFunctionContentsWithCodeBlock(function)}')) # from line 67, col 1.
            ...
            if _v is not None: write(_filter(_v, rawExpr='${evaluateOperatorFunctionContentsWithoutCodeBlock(function)}')) # from line 69, col 1.
        # 
    ...
    def evaluateOperatorFunctionContentsWithCodeBlock(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${callEvaluateLoop}')) # from line 76, col 1.
        # 
...
_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${resultVector.id}')) # from line 80, col 2.
            write('''_basis = ''')
            _v = VFFSL(SL,"basisIndexForBasis",False)(VFFSL(SL,"operatorBasis",True)) # u'$basisIndexForBasis($operatorBasis)' on line 80, col 29
            if _v is not None: write(_filter(_v, rawExpr='$basisIndexForBasis($operatorBasis)')) # from line 80, col 29.
            write(''';
''')
        # 
    ...
    def callEvaluateLoop(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${codeBlocks['operatorDefinition'].loop(self.insideEvaluateOperatorLoops)}")) # from line 86, col 1.
    ...
    def insideEvaluateOperatorLoopsBegin(self, **KWS):
        ...
        if not VFFSL(SL,"operatorVector",True): # generated from line 91, col 3
            ...
            for operatorComponentName, operatorComponentDictionary in VFN(VFFSL(SL,"operatorComponents",True),"iteritems",False)(): # generated from line 95, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${typeName}')) # from line 101, col 1.
                write(''' ''')
                _v = VFFSL(SL,"operatorComponentName",True) # u'${operatorComponentName}' on line 101, col 13
                if _v is not None: write(_filter(_v, rawExpr='${operatorComponentName}')) # from line 101, col 13.
                write(''';
''')
            write('''
''')
    ...
    def evaluateOperatorFunctionContentsWithoutCodeBlock(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($targetVectors, $operatorBasis)}')) # from line 112, col 1.
        # 
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${evaluateOperatorLoop(setOfVectorsToLoopOver)}')) # from line 122, col 1.
        # 
...
_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${resultVector.id}')) # from line 126, col 2.
            write('''_basis = ''')
            _v = VFFSL(SL,"basisIndexForBasis",False)(VFFSL(SL,"operatorBasis",True)) # u'$basisIndexForBasis($operatorBasis)' on line 126, col 29
            if _v is not None: write(_filter(_v, rawExpr='$basisIndexForBasis($operatorBasis)')) # from line 126, col 29.
            write(''';
''')
        # 
    ...
    def optimisedOperatorCopyBegin(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${resultVector.id}')) # from line 144, col 16.
        write(''', _active_''')
        _v = VFFSL(SL,"targetVector.id",True) # u'${targetVector.id}' on line 144, col 44
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 144, col 44.
        write(''', ''')
        _v = VFFSL(SL,"targetVector.allocSize",True) # u'${targetVector.allocSize}' on line 144, col 64
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.allocSize}')) # from line 144, col 64.
        write(''' * sizeof(''')
        _v = VFFSL(SL,"targetVector.type",True) # u'${targetVector.type}' on line 144, col 99
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.type}')) # from line 144, col 99.
        write('''));
''')
        _v = VFFSL(SL,"targetVector.type",True) # u'${targetVector.type}' on line 145, col 1
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.type}')) # from line 145, col 1.
        write(''' *__backup_ptr = _active_''')
        _v = VFFSL(SL,"targetVector.id",True) # u'${targetVector.id}' on line 145, col 46
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 145, col 46.
        write(''';
ptrdiff_t __backup_basis = _''')
        _v = VFFSL(SL,"targetVector.id",True) # u'${targetVector.id}' on line 146, col 29
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 146, col 29.
        write('''_basis;
_active_''')
        _v = VFFSL(SL,"targetVector.id",True) # u'${targetVector.id}' on line 147, col 9
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 147, col 9.
        write(''' = _active_''')
        _v = VFFSL(SL,"resultVector.id",True) # u'${resultVector.id}' on line 147, col 38
        if _v is not None: write(_filter(_v, rawExpr='${resultVector.id}')) # from line 147, col 38.
        write(''';
...
''')
    ...
    def optimisedOperatorCopyEnd(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 160, col 9.
        write(''' = __backup_ptr;
_''')
        _v = VFFSL(SL,"targetVector.id",True) # u'${targetVector.id}' on line 161, col 2
        if _v is not None: write(_filter(_v, rawExpr='${targetVector.id}')) # from line 161, col 2.
