...
class NonConstantEXOperator(_EXOperator):
    ...
    def insideEvaluateOperatorLoops(self, codeString, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${insideEvaluateOperatorLoopsBegin}')) # from line 31, col 1.
        # 
...
''')
        for operatorComponentNumber, (operatorComponentName, operatorComponentVectors) in enumerate(VFN(VFFSL(SL,"operatorComponents",True),"iteritems",False)()): # generated from line 40, col 3
            for targetVectorComponents in operatorComponentVectors.values(): # generated from line 41, col 5
                for targetVectorComponent in targetVectorComponents: # generated from line 42, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${operatorComponentName}')) # from line 43, col 4.
                    write('''[''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'$targetVectorComponent' on line 43, col 29
                    if _v is not None: write(_filter(_v, rawExpr='$targetVectorComponent')) # from line 43, col 29.
                    write(''']
_''')
                    _v = VFFSL(SL,"operatorComponentName",True) # u'${operatorComponentName}' on line 44, col 2
                    if _v is not None: write(_filter(_v, rawExpr='${operatorComponentName}')) # from line 44, col 2.
                    write('''_''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'${targetVectorComponent}' on line 44, col 27
                    if _v is not None: write(_filter(_v, rawExpr='${targetVectorComponent}')) # from line 44, col 27.
                    write(''' = ''')
                    _v = VFFSL(SL,"operatorComponentName",True) # u'$operatorComponentName' on line 44, col 54
                    if _v is not None: write(_filter(_v, rawExpr='$operatorComponentName')) # from line 44, col 54.
                    write(''' * ''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'$targetVectorComponent' on line 44, col 79
                    if _v is not None: write(_filter(_v, rawExpr='$targetVectorComponent')) # from line 44, col 79.
                    write(''';
''')
        # 
    ...
    def callEvaluateLoop(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${optimisedOperatorCopyBegin}')) # from line 53, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr='${optimisedOperatorCopyEnd}')) # from line 57, col 1.
        # 
