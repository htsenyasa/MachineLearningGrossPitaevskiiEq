...
class ConstantIPOperator(_IPOperator):
    ...
    def calculateOperatorFieldFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.createStepVariable}')) # from line 30, col 1.
        write('''
''')
    ...
    def insideCalculateOperatorFieldLoops(self, codeString, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${insideCalculateOperatorFieldLoopsBegin}')) # from line 39, col 1.
        # 
...
#define """)
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 47, col 9.
        write(''' Dont_use_propagation_dimension_''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 47, col 64
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 47, col 64.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${codeString}')) # from line 49, col 1.
        write('''// **********************************************
#undef ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 51, col 8
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 51, col 8.
        write('''
''')
...
''')
            ...
            for operatorComponentNumber, operatorComponent in enumerate(VFN(VFFSL(SL,"operatorComponents",True),"iterkeys",False)()): # generated from line 56, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${operatorVector.id}')) # from line 58, col 2.
                write('''[_''')
                _v = VFFSL(SL,"operatorVector.id",True) # u'${operatorVector.id}' on line 58, col 24
                if _v is not None: write(_filter(_v, rawExpr='${operatorVector.id}')) # from line 58, col 24.
                write('''_index_pointer + ''')
                _v = VFFSL(SL,"offsetIndex",True) # u'${offsetIndex}' on line 58, col 61
                if _v is not None: write(_filter(_v, rawExpr='${offsetIndex}')) # from line 58, col 61.
                write('''] = ''')
                _v = VFFSL(SL,"expFunction",True) # u'${expFunction}' on line 58, col 79
                if _v is not None: write(_filter(_v, rawExpr='${expFunction}')) # from line 58, col 79.
                write('''(''')
                _v = VFFSL(SL,"operatorComponent",True) # u'${operatorComponent}' on line 58, col 94
                if _v is not None: write(_filter(_v, rawExpr='${operatorComponent}')) # from line 58, col 94.
                _v = VFFSL(SL,"valueSuffix",True) # u'${valueSuffix}' on line 58, col 114
                if _v is not None: write(_filter(_v, rawExpr='${valueSuffix}')) # from line 58, col 114.
                write(''' * ''')
                _v = VFFSL(SL,"propagationStepFraction",True) # u'$propagationStepFraction' on line 58, col 131
                if _v is not None: write(_filter(_v, rawExpr='$propagationStepFraction')) # from line 58, col 131.
                write(''' * _step);
''')
        # 
    ...
    def exponentIndex(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${len($operatorComponents)}')) # from line 65, col 24.
