...
class MultiPathDriver(_MultiPathDriver):
    ...
    def segment0_loop(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${pathLoopStart}')) # from line 32, col 17.
        write('''; _i0 < ''')
        _v = VFFSL(SL,"pathLoopEnd",True) # u'${pathLoopEnd}' on line 32, col 41
        if _v is not None: write(_filter(_v, rawExpr='${pathLoopEnd}')) # from line 32, col 41.
        write('''; _i0+=''')
        _v = VFFSL(SL,"pathLoopStep",True) # u'${pathLoopStep}' on line 32, col 62
        if _v is not None: write(_filter(_v, rawExpr='${pathLoopStep}')) # from line 32, col 62.
        write(''') {
...
''')
    ...
    def defines(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${pathCount}')) # from line 41, col 18.
        write('''
''')
        # 
...
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('topLevelSequenceBegin', featureOrdering, dict), autoIndent=True}")) # from line 52, col 3.
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${topLevelSegmentPathLoop, autoIndent=True, extraIndent=extraIndent}')) # from line 55, col 3.
        write('''
  ''')
...
''')
    ...
    def topLevelSegmentPathLoop(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${topLevelSequence.allocate}')) # from line 71, col 1.
        write('''
''')
        ...
        for o in VFFSL(SL,"objectsNeedingInitialisation",True): # generated from line 74, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${o.initialise}')) # from line 75, col 1.
        # 
        ...
        for o in VFFSL(SL,"objectsNeedingInitialisation",True): # generated from line 83, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${o.finalise}')) # from line 84, col 1.
        write('''
''')
        _v = VFFSL(SL,"topLevelSequence.free",True) # u'${topLevelSequence.free}' on line 87, col 1
        if _v is not None: write(_filter(_v, rawExpr='${topLevelSequence.free}')) # from line 87, col 1.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segment0_loop}')) # from line 90, col 1.
        write('''
...
''')
        for mg in VFFSL(SL,"momentGroups",True): # generated from line 92, col 3
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${mg.rawVector.functions['initialise'].call(), autoIndent=True}")) # from line 93, col 3.
        write('''  
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${topLevelSequence.topLevelSequenceInnerContent, autoIndent=True}')) # from line 96, col 3.
        write('''}
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${finalisationCode}')) # from line 100, col 1.
        # 
    ...
    def insideMomentGroupProcessingNoProcessingCodeLoop(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${momentGroup.outputField.name}')) # from line 117, col 2.
...
''')
            for arrayName in VFFSL(SL,"otherArrayNames",True): # generated from line 180, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 181, col 1.
