...
int main(int argc, char **argv)
{
    ...
    #if __MAC_OS_X_VERSION_MIN_REQUIRED >= 1080
  {
    ...
    IOReturn __io_result = IOPMAssertionCreateWithDescription(
      ...
      CFSTR("XMDS simulation 'xgp2d' preventing user idle sleep"), // Assertion name
...
void _print_usage()
{
  ...
  _LOG(_NO_ERROR_TERMINATE_LOG_LEVEL, "\n\nUsage: xgp2d --interaction <real> --pottype <real> --xshift <real> --yshift <real> --wx <real> --wy <real> --rw <real> --lw <real> --uw <real> --bw <real> --xlam1 <real> --xlam2 <real> --xmu1 <real> --xmu2 <real> --xs1 <real> --xs2 <real> --ylam1 <real> --ylam2 <real> --ymu1 <real> --ymu2 <real> --ys1 <real> --ys2 <real>\n\n"
                         "Details:\n"
...
void _write_output()
{
  _LOG(_SIMULATION_LOG_LEVEL, "Generating output for xgp2d\n");
