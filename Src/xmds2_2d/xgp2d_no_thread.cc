...
int main(int argc, char **argv)
{
    ...
    #if __MAC_OS_X_VERSION_MIN_REQUIRED >= 1080
  {
    ...
    IOReturn __io_result = IOPMAssertionCreateWithDescription(
      ...
      CFSTR("XMDS simulation 'xgp2d_no_thread' preventing user idle sleep"), // Assertion name
  ...
  while (1) {
    static struct option long_options[] = 
      {
        ...
        {"xlam1", required_argument, 0, 'm'},
        {"xlam2", required_argument, 0, '2'},
        {"xmu1", required_argument, 0, '1'},
        {"xmu2", required_argument, 0, 'c'},
        {"xs1", required_argument, 0, 's'},
        {"xs2", required_argument, 0, 'd'},
        {"ylam1", required_argument, 0, 'e'},
        {"ylam2", required_argument, 0, 'f'},
        {"ymu1", required_argument, 0, 'g'},
        {"ymu2", required_argument, 0, 'j'},
        {"ys1", required_argument, 0, 'k'},
        {"ys2", required_argument, 0, 'n'},
        {NULL, 0, 0, 0}
      };
    
    int option_index = 0;
  
    resp = getopt_long(argc, argv, "hi:p:x:y:w:a:r:l:u:b:m:2:1:c:s:d:e:f:g:j:k:n:", long_options, &option_index);
    ...
    switch (resp) {
      ...
      case 'm':
        xlam1 = strtod(optarg, NULL);
        break;
      
      case '2':
        xlam2 = strtod(optarg, NULL);
        break;
      
      case '1':
        xmu1 = strtod(optarg, NULL);
        break;
      
      case 'c':
        xmu2 = strtod(optarg, NULL);
        break;
      
      case 's':
        xs1 = strtod(optarg, NULL);
        break;
      
      case 'd':
        xs2 = strtod(optarg, NULL);
        break;
      
      case 'e':
        ylam1 = strtod(optarg, NULL);
        break;
      
      case 'f':
        ylam2 = strtod(optarg, NULL);
        break;
      
      case 'g':
        ymu1 = strtod(optarg, NULL);
        break;
      
      case 'j':
        ymu2 = strtod(optarg, NULL);
        break;
      
      case 'k':
        ys1 = strtod(optarg, NULL);
        break;
      
      case 'n':
        ys2 = strtod(optarg, NULL);
        break;
...
void _print_usage()
{
  ...
  _LOG(_NO_ERROR_TERMINATE_LOG_LEVEL, "\n\nUsage: xgp2d_no_thread --interaction <real> --pottype <real> --xshift <real> --yshift <real> --wx <real> --wy <real> --rw <real> --lw <real> --uw <real> --bw <real> --xlam1 <real> --xlam2 <real> --xmu1 <real> --xmu2 <real> --xs1 <real> --xs2 <real> --ylam1 <real> --ylam2 <real> --ymu1 <real> --ymu2 <real> --ys1 <real> --ys2 <real>\n\n"
                         "Details:\n"
...
void _xy_gradphi_evaluate()
{
  ...
  for (long _index_kx = 0; _index_kx < _lattice_kx; _index_kx++) {
    ...
    for (long _index_ky = 0; _index_ky < _lattice_ky; _index_ky++) {
      // ************* Evaluation code ****************
      #line 176 "gp2d_no_thread.xmds"
      
      dphix=i*kx*phi;
      dphiy=i*ky*phi;
      
      #line 1467 "xgp2d_no_thread.cc"
      // **********************************************
      // Increment index pointers for vectors in field xy (or having the same dimensions)
      _xy_wavefunction_index_pointer += 1 * _xy_wavefunction_ncomponents;
...
void _segment1__evaluate_operator0()
{
  ...
  for (long _index_x = 0; _index_x < _lattice_x; _index_x++) {
    ...
    for (long _index_y = 0; _index_y < _lattice_y; _index_y++) {
      ...
      // ************** Filter code *****************
      #line 203 "gp2d_no_thread.xmds"
      
      phi *= sqrt(Nptls/Ncalc);
      
      #line 1652 "xgp2d_no_thread.cc"
      // **********************************************
      // Increment index pointers for vectors in field xy (or having the same dimensions)
      _xy_wavefunction_index_pointer += 1 * _xy_wavefunction_ncomponents;
...
void _segment2_xy_operators_calculate_operator0_field(real _step, int _exponent)
{
  ...
  for (long _index_kx = 0; _index_kx < _lattice_kx; _index_kx++) {
    ...
    // ************** Operator code *****************
    #line 223 "gp2d_no_thread.xmds"
    
    Tx = -0.5*kx*kx;
    
    #line 2397 "xgp2d_no_thread.cc"
    // **********************************************
    #undef t
...
void _segment2_xy_operators_calculate_operator1_field(real _step, int _exponent)
{
  ...
  for (long _index_ky = 0; _index_ky < _lattice_ky; _index_ky++) {
    ...
    #define t Dont_use_propagation_dimension_t_in_constant_IP_operator___Use_non_constant_EX_operator_instead
    // ************** Operator code *****************
    #line 229 "gp2d_no_thread.xmds"
    
    Ty = -0.5*ky*ky;
    
    #line 2445 "xgp2d_no_thread.cc"
    // **********************************************
    #undef t
...
void _segment2__evaluate_operator0()
{
  ...
  for (long _index_x = 0; _index_x < _lattice_x; _index_x++) {
    ...
    for (long _index_y = 0; _index_y < _lattice_y; _index_y++) {
      ...
      // ************** Filter code *****************
      #line 214 "gp2d_no_thread.xmds"
      
      // Correct normalisation of the wavefunction
      phi *= sqrt(Nptls/Ncalc);
      
      #line 2540 "xgp2d_no_thread.cc"
      // **********************************************
      // Increment index pointers for vectors in field xy (or having the same dimensions)
      _xy_wavefunction_index_pointer += 1 * _xy_wavefunction_ncomponents;
...
void _segment3__evaluate_operator0()
{
  ...
  // ************** Filter code *****************
  #line 252 "gp2d_no_thread.xmds"
  
  printf(" ");
  printf(" %lf", 5.);
  printf(" ");
  
  #line 2579 "xgp2d_no_thread.cc"
  // **********************************************
}
...
void _write_output()
{
  _LOG(_SIMULATION_LOG_LEVEL, "Generating output for xgp2d_no_thread\n");
...
void _write_xsil_header(FILE* fp)
{
  ...
  fprintf(fp, "  <name>xgp2d_no_thread</name>\n");
  ...
  fprintf(fp, "        real lm_x_1, lm_x_2, mu_x_1, mu_x_2, s_x_1, s_x_2; //params of double inverted gaussian distribution X\n");
  fprintf(fp, "        real lm_y_1, lm_y_2, mu_y_1, mu_y_2, s_y_1, s_y_2; //params of double inverted gaussian distribution Y\n");
  ...
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      \n");
  fprintf(fp, "      <!-- ****************** Infinite Well Params  ********************** -->\n");
  fprintf(fp, "            \n");
  ...
  fprintf(fp, "\n");
  fprintf(fp, "\n");
  fprintf(fp, "      <!-- ****************** Double Inverted Gaussian Params X  ********************** -->\n");
  fprintf(fp, "\n");
  fprintf(fp, "      <argument default_value=\"3\" name=\"xlam1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      lm_x_1 = xlam1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"xlam2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      lm_x_2 = xlam2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"-2\" name=\"xmu1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      mu_x_1 = xmu1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"xmu2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      mu_x_2 = xmu2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"xs1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      s_x_1 = xs1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"xs2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      s_x_2 = xs2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "\n");
  fprintf(fp, "      <!-- ****************** Double Inverted Gaussian Params Y ********************** -->\n");
  fprintf(fp, "    \n");
  fprintf(fp, "\n");
  fprintf(fp, "      <argument default_value=\"3\" name=\"ylam1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      lm_y_1 = ylam1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"ylam2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      lm_y_2 = xlam2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"-2\" name=\"ymu1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      mu_y_1 = ymu1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"ymu2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      mu_y_2 = ymu2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"ys1\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      s_y_1 = ys1;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "      <argument default_value=\"2\" name=\"ys2\" type=\"real\"/>\n");
  fprintf(fp, "      <![CDATA[\n");
  fprintf(fp, "      s_y_2 = ys2;\n");
  fprintf(fp, "      ]]>\n");
  fprintf(fp, "    </arguments>\n");
  fprintf(fp, "\n");
  fprintf(fp, "  </features>\n");
  ...
  fprintf(fp, "        case 2: Vext = -((lm_x_1 * exp(-((x-mu_x_1)*(x-mu_x_1)) / (s_x_1 * s_x_1))) + (lm_x_2 * exp(-((x-mu_x_2)*(x-mu_x_2)) / (s_x_2 * s_x_2)))) * ((lm_y_1 * exp(-((y-mu_y_1)*(y-mu_y_1)) / (s_y_1 * s_y_1))) + (lm_y_2 * exp(-((y-mu_y_2)*(y-mu_y_2)) / (s_y_2 * s_y_2)))); break;\n");
  fprintf(fp, "        //case 2: Vext = - ((lm_x_1 * exp(-((x-mu_x_1)*(x-mu_x_1)) / (s_x_1 * s_x_1))) ) * ((lm_y_1 * exp(-((y-mu_y_1)*(y-mu_y_1)) / (s_y_1 * s_y_1))));\n");
  fprintf(fp, "        }\n");
  fprintf(fp, "\n");
  fprintf(fp, "        //printf(\"*************\\n%%lf %%lf %%lf %%lf %%lf %%lf\\n\", lm_x_1, lm_x_2, mu_x_1, mu_x_2, s_x_1, s_x_2); \n");
  fprintf(fp, "        //printf(\"*************\\n%%lf %%lf %%lf %%lf %%lf %%lf\\n\", lm_y_1, lm_y_2, mu_y_1, mu_y_2, s_y_1, s_y_2); \n");
  ...
  fprintf(fp, "  Command line argument xlam1 = %e\n", xlam1);
  
  fprintf(fp, "  Command line argument xlam2 = %e\n", xlam2);
  
  fprintf(fp, "  Command line argument xmu1 = %e\n", xmu1);
  
  fprintf(fp, "  Command line argument xmu2 = %e\n", xmu2);
  
  fprintf(fp, "  Command line argument xs1 = %e\n", xs1);
  
  fprintf(fp, "  Command line argument xs2 = %e\n", xs2);
  
  fprintf(fp, "  Command line argument ylam1 = %e\n", ylam1);
  
  fprintf(fp, "  Command line argument ylam2 = %e\n", ylam2);
  
  fprintf(fp, "  Command line argument ymu1 = %e\n", ymu1);
  
  fprintf(fp, "  Command line argument ymu2 = %e\n", ymu2);
  
  fprintf(fp, "  Command line argument ys1 = %e\n", ys1);
  
  fprintf(fp, "  Command line argument ys2 = %e\n", ys2);
  fprintf(fp, "</info>\n");
...
void _mg1_sample()
{
  ...
  for (long _index_x = 0; _index_x < _lattice_x; _index_x++) {
    ...
    for (long _index_y = 0; _index_y < _lattice_y; _index_y++) {
      ...
      // *************** Sampling code ****************
      #line 283 "gp2d_no_thread.xmds"
      
      Pot = Vext;
      
      #line 3284 "xgp2d_no_thread.cc"
      // **********************************************
...
void _mg2_sample()
{
  ...
  for (long _index_x = 0; _index_x < _lattice_x; _index_x++) {
    ...
    for (long _index_y = 0; _index_y < _lattice_y; _index_y++) {
      ...
      // *************** Sampling code ****************
      #line 290 "gp2d_no_thread.xmds"
      
      dens = mod2(phi);
      
      #line 3485 "xgp2d_no_thread.cc"
      // **********************************************
