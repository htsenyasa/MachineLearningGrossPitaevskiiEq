...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${allocate}')) # from line 35, col 1.
            _v = VFFSL(SL,"initialise",True) # u'${initialise}' on line 36, col 1
            if _v is not None: write(_filter(_v, rawExpr='${initialise}')) # from line 36, col 1.
            write('''for (unsigned long _cycle = 0; _cycle < ''')
            _v = VFFSL(SL,"localCycles",True) # u'${localCycles}' on line 37, col 41
            if _v is not None: write(_filter(_v, rawExpr='${localCycles}')) # from line 37, col 41.
            write('''; _cycle++) {
''')
            extraIndent = 2
        # 
        _v = VFFSL(SL,"callChildSegments",False)(function) # u'${callChildSegments(function), extraIndent=extraIndent}' on line 41, col 1
        if _v is not None: write(_filter(_v, extraIndent=extraIndent, rawExpr='${callChildSegments(function), extraIndent=extraIndent}')) # from line 41, col 1.
        # 
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${finalise}')) # from line 47, col 1.
            _v = VFFSL(SL,"free",True) # u'${free}' on line 48, col 1
            if _v is not None: write(_filter(_v, rawExpr='${free}')) # from line 48, col 1.
        # 
    ...
    def callChildSegments(self, function, **KWS):
        ...
        for segment in VFFSL(SL,"childSegments",True): # generated from line 55, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr="${segment.functions['segment'].call(parentFunction=function)}")) # from line 56, col 1.
            write('''
''')
        # 
    ...
    def allocate(self, **KWS):
        ...
        for segment in VFFSL(SL,"childSegments",True): # generated from line 66, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$segment.allocate')) # from line 67, col 1.
        # 
    ...
    def free(self, **KWS):
        ...
        for segment in VFFSL(SL,"childSegments",True): # generated from line 77, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$segment.free')) # from line 78, col 1.
        # 
    ...
    def initialise(self, **KWS):
        ...
        for segment in VFFSL(SL,"childSegments",True): # generated from line 88, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$segment.initialise')) # from line 89, col 1.
        # 
    ...
    def finalise(self, **KWS):
        ...
        for segment in VFFSL(SL,"childSegments",True): # generated from line 99, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$segment.finalise')) # from line 100, col 1.
        # 
