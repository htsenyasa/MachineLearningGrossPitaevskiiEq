...
class AdaptiveStep(Integrator):
    ...
    def functionPrototypes(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 35, col 14.
...
''')
        ...
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 37, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 38, col 14.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 38, col 31
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 38, col 31.
            write('''_timestep_error(''')
            _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 38, col 59
            if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 38, col 59.
            write('''* _checkfield);
bool _segment''')
            _v = VFFSL(SL,"segmentNumber",True) # u'${segmentNumber}' on line 39, col 14
            if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 39, col 14.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 39, col 31
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 39, col 31.
            write('''_reset(''')
            _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 39, col 50
            if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 39, col 50.
            write('''* _reset_to);
''')
        # 
    ...
    def functionImplementations(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${setupSamplingFunctionImplementation}')) # from line 52, col 1.
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${timestepErrorFunctionImplementation($vector)}')) # from line 55, col 1.
            write('''
''')
            _v = VFFSL(SL,"resetFunctionImplementation",False)(VFFSL(SL,"vector",True)) # u'${resetFunctionImplementation($vector)}' on line 57, col 1
            if _v is not None: write(_filter(_v, rawExpr='${resetFunctionImplementation($vector)}')) # from line 57, col 1.
        # 
    ...
    def setupSamplingFunctionImplementation(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 65, col 14.
        write('''_setup_sampling(bool* _next_sample_flag, long* _next_sample_counter)
{
  ...
  long _momentGroupNumbersNeedingSamplingNext[''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${len($samples) + 1}')) # from line 69, col 47.
        write('''];
  ...
  real _''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 75, col 9.
        write('''_break_next = (real)''')
        _v = VFFSL(SL,"interval",True) # u'${interval}' on line 75, col 52
        if _v is not None: write(_filter(_v, rawExpr='${interval}')) # from line 75, col 52.
        write(''';
  _momentGroupNumbersNeedingSamplingNext[0] = ''')
        _v = VFFSL(SL,"len",False)(VFFSL(SL,"samples",True)) # u'${len($samples)}' on line 76, col 47
        if _v is not None: write(_filter(_v, rawExpr='${len($samples)}')) # from line 76, col 47.
        write(''';
  
  // initialise all flags to false
  for (long _i0 = 0; _i0 < ''')
        _v = VFFSL(SL,"len",False)(VFFSL(SL,"samples",True)) + 1 # u'${len($samples) + 1}' on line 79, col 28
        if _v is not None: write(_filter(_v, rawExpr='${len($samples) + 1}')) # from line 79, col 28.
        write('''; _i0++)
...
''')
        for momentGroupNumber, sampleCount in enumerate(VFFSL(SL,"samples",True)): # generated from line 86, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 90, col 28.
            write('''] * _previous_M == _previous_m * ''')
            _v = VFFSL(SL,"sampleCount",True) # u'$sampleCount' on line 90, col 79
            if _v is not None: write(_filter(_v, rawExpr='$sampleCount')) # from line 90, col 79.
            write(''') {
    _momentGroupNumbersNeedingSamplingNext[_numberOfMomentGroupsToBeSampledNext] = ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 91, col 84.
            write(''';
    _numberOfMomentGroupsToBeSampledNext++;
            ...
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 93, col 35.
            write('''] * _previous_M < _previous_m * ''')
            _v = VFFSL(SL,"sampleCount",True) # u'$sampleCount' on line 93, col 85
            if _v is not None: write(_filter(_v, rawExpr='$sampleCount')) # from line 93, col 85.
            write(''') {
    _''')
            _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 94, col 6
            if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 94, col 6.
            write('''_break_next = _next_sample_counter[''')
            _v = VFFSL(SL,"momentGroupNumber",True) # u'$momentGroupNumber' on line 94, col 64
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 94, col 64.
            write('''] * ((real)''')
            _v = VFFSL(SL,"interval",True) # u'$interval' on line 94, col 93
            if _v is not None: write(_filter(_v, rawExpr='$interval')) # from line 94, col 93.
            write(''') / ((real)''')
            _v = VFFSL(SL,"sampleCount",True) # u'$sampleCount' on line 94, col 113
            if _v is not None: write(_filter(_v, rawExpr='$sampleCount')) # from line 94, col 113.
            write(''');
    _numberOfMomentGroupsToBeSampledNext = 1;
    _momentGroupNumbersNeedingSamplingNext[0] = ''')
            _v = VFFSL(SL,"momentGroupNumber",True) # u'$momentGroupNumber' on line 96, col 49
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 96, col 49.
            write(''';
    _previous_M = ''')
            _v = VFFSL(SL,"sampleCount",True) # u'$sampleCount' on line 97, col 19
            if _v is not None: write(_filter(_v, rawExpr='$sampleCount')) # from line 97, col 19.
            write(''';
    _previous_m = _next_sample_counter[''')
            _v = VFFSL(SL,"momentGroupNumber",True) # u'$momentGroupNumber' on line 98, col 40
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 98, col 40.
            write('''];
  }
...
''')
  ...
  return _''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 107, col 11.
        write('''_break_next;
}
''')
        # 
    ...
    def timestepErrorFunctionImplementation(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 115, col 14.
        write('''_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 115, col 31
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 115, col 31.
        write('''_timestep_error(''')
        _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 115, col 59
        if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 115, col 59.
        write('''* _checkfield)
{
  real _error = 1e-24;
...
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('timestepErrorBegin', featureOrdering, {'vector': vector}), autoIndent=True}")) # from line 123, col 3.
        write('''  
''')
  ...
  for (long _i0 = 0; _i0 < _''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 130, col 29.
  ...
  
  {
    ''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${loopOverVectorsInBasisWithInnerContent([vector], $homeBasis, $insideFindPeakLoops(vector)), autoIndent=True}')) # from line 134, col 5.
            write('''  }
  ''')
            _v = VFFSL(SL,"insertCodeForFeatures",False)('findMax', ['Driver'], {'variable': '_cutoff', 'count': ''.join(['_',str(VFFSL(SL,"vector.id",True)),'_ncomponents'])}) # u"${insertCodeForFeatures('findMax', ['Driver'], {'variable': '_cutoff', 'count': c'_${vector.id}_ncomponents'}), autoIndent=True}" on line 136, col 3
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('findMax', ['Driver'], {'variable': '_cutoff', 'count': c'_${vector.id}_ncomponents'}), autoIndent=True}")) # from line 136, col 3.
            write('''  
  for (long _i0 = 0; _i0 < _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 138, col 29
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 138, col 29.
            write('''_ncomponents; _i0++) {
    if (_xmds_isnonfinite(_cutoff[_i0]))
      ...
      return 2.0*''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${tolerance}')) # from line 141, col 18.
            write(''';
    _cutoff[_i0] *= ''')
            _v = VFFSL(SL,"cutoff",True) # u'${cutoff}' on line 142, col 21
            if _v is not None: write(_filter(_v, rawExpr='${cutoff}')) # from line 142, col 21.
            write(''';
''')
            if VFFSL(SL,"vector.type",True) == 'complex': # generated from line 143, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${cutoff}')) # from line 146, col 21.
                write(''';
''')
            write('''  }
''')
...
''')
    ...
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${loopOverVectorsInBasisWithInnerContent([vector], $homeBasis, $insideFindMaxErrorLoops(vector)), autoIndent=True}')) # from line 160, col 5.
        write('''  }
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('findMax', ['Driver'], {'variable': '&_error', 'count': '1'}), autoIndent=True}")) # from line 162, col 3.
        write('''  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('timestepErrorEnd', featureOrdering, dict), autoIndent=True}")) # from line 163, col 3.
        write('''  
  return _error;
}
''')
    ...
    def insideFindPeakLoops(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 173, col 27.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${modFunction}')) # from line 179, col 15.
        write('''(_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 179, col 31
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 179, col 31.
        write('''[_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 179, col 45
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 179, col 45.
...
''')
    ...
    def insideFindMaxErrorLoops(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 191, col 28.
        write('''_ncomponents; _i1++) {
''')
        ...
        if len(VFFSL(SL,"vector.field.dimensions",True)) > 0: # generated from line 197, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${modCutoffFunction}')) # from line 198, col 7.
            write('''(_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 198, col 29
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 198, col 29.
            write('''[_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 198, col 43
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 198, col 43.
    ...
    ''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${updateMaximumError($vector), autoIndent=True}')) # from line 199, col 5.
            write('''  }
''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${updateMaximumError($vector), autoIndent=True}')) # from line 202, col 3.
        write('''}
''')
        # 
    ...
    def insideLookForNaNLoops(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 216, col 29.
        write('''_ncomponents; _i1++) {
''')
        if VFFSL(SL,"vector.type",True) == 'complex': # generated from line 217, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 218, col 28.
            write('''[_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 218, col 42
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 218, col 42.
            write('''_index_pointer + _i1].Re())
      || _xmds_isnonfinite(_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 219, col 29
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 219, col 29.
            write('''[_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 219, col 43
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 219, col 43.
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 221, col 28.
            write('''[_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 221, col 42
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 221, col 42.
...
''')
    ...
    def updateMaximumError(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 20.
        write('''[_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 229, col 34
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 34.
        write('''_index_pointer + _i1] - _checkfield[_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 229, col 83
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 83.
        write('''_index_pointer + _i1]) / (0.5*abs(_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 229, col 130
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 130.
        write('''[_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 229, col 144
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 144.
        write('''_index_pointer + _i1]) + 0.5*abs(_checkfield[_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 229, col 202
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 229, col 202.
        write('''_index_pointer + _i1]));
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('updateMaximumError', ['Diagnostics'], {'vector': vector})}")) # from line 240, col 1.
        # 
    ...
    def resetFunctionImplementation(self, vector, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 247, col 14.
        write('''_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 247, col 31
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 247, col 31.
        write('''_reset(''')
        _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 247, col 50
        if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 247, col 50.
        write('''* _reset_to_''')
        _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 247, col 76
        if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 247, col 76.
        write(''')
{
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${copyVectors([vector], destPrefix = '', srcPrefix = '_reset_to'), autoIndent=True}")) # from line 249, col 3.
        write("""  
  ...
  bool bNoNaNsPresent = true;
  {
    """)
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${loopOverVectorsInBasisWithInnerContent([vector], $homeBasis, $insideLookForNaNLoops(vector)), autoIndent=True}')) # from line 254, col 5.
        write('''  }
...
''')
    ...
    def createToleranceVariable(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${tolerance}')) # from line 267, col 19.
        write(''';
''')
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('createToleranceVariable', featureOrdering)}")) # from line 270, col 1.
        # 
    ...
    def segmentFunctionBody(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${interval}')) # from line 276, col 14.
        write('''/(real)''')
        _v = VFFSL(SL,"stepCount",True) # u'${stepCount}' on line 276, col 32
        if _v is not None: write(_filter(_v, rawExpr='${stepCount}')) # from line 276, col 32.
        write(''';
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${createToleranceVariable}')) # from line 283, col 1.
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('integrateAdaptiveStepBegin', featureOrderingOuter)}")) # from line 286, col 1.
        write('''
...
''')
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 289, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 290, col 7.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 290, col 15
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 290, col 15.
            write('''_error;
''')
        write('''
bool _discard = false;
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${momentGroupCount + 2}')) # from line 297, col 24.
        write('''];
for (long _i0 = 0; _i0 < ''')
        _v = VFFSL(SL,"momentGroupCount",True) + 2 # u'${momentGroupCount + 2}' on line 298, col 26
        if _v is not None: write(_filter(_v, rawExpr='${momentGroupCount + 2}')) # from line 298, col 26.
        write('''; _i0++)
  _next_sample_flag[_i0] = false;

long _next_sample_counter[''')
        _v = VFFSL(SL,"momentGroupCount",True) # u'$momentGroupCount' on line 301, col 27
        if _v is not None: write(_filter(_v, rawExpr='$momentGroupCount')) # from line 301, col 27.
        write('''];
for (long _i0 = 0; _i0 < ''')
        _v = VFFSL(SL,"momentGroupCount",True) # u'$momentGroupCount' on line 302, col 26
        if _v is not None: write(_filter(_v, rawExpr='$momentGroupCount')) # from line 302, col 26.
        write('''; _i0++)
  _next_sample_counter[_i0] = 1;

real _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 305, col 7
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 305, col 7.
        write('''_local = 0.0;
...
real _''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 307, col 45.
...
if ( (_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 309, col 8.
        write('''_local + _step)*(1.0 + _EPSILON) >= _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 309, col 68
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 309, col 68.
        write('''_break_next) {
  _break_next = true;
  _step = _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 311, col 12
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 311, col 12.
        write('''_break_next - _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 311, col 50
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 311, col 50.
        write('''_local;
}

''')
        _v = VFFSL(SL,"allocate",True) # u'${allocate}' on line 314, col 1
        if _v is not None: write(_filter(_v, rawExpr='${allocate}')) # from line 314, col 1.
        _v = VFFSL(SL,"initialise",True) # u'${initialise}' on line 315, col 1
        if _v is not None: write(_filter(_v, rawExpr='${initialise}')) # from line 315, col 1.
        _v = VFFSL(SL,"localInitialise",True) # u'${localInitialise}' on line 316, col 1
        if _v is not None: write(_filter(_v, rawExpr='${localInitialise}')) # from line 316, col 1.
        write('''
do {
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('integrateAdaptiveStepOuterLoopBegin', featureOrderingOuterLoop), autoIndent=True}")) # from line 320, col 3.
        write('''  
  ''')
        _v = VFFSL(SL,"preSingleStep",True) # u'${preSingleStep, autoIndent=True}' on line 322, col 3
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${preSingleStep, autoIndent=True}')) # from line 322, col 3.
        write('''  do {
''')
        #  Insert code for features
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('integrateAdaptiveStepInnerLoopBegin', featureOrderingInnerLoop), autoIndent=True}")) # from line 326, col 5.
        write('''    
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${stepper.singleIntegrationStep(function), autoIndent=True}')) # from line 328, col 5.
        write('''    
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('integrateAdaptiveStepInnerLoopEnd', featureOrderingInnerLoop), autoIndent=True}")) # from line 330, col 5.
        write('''    
    _error = 0.0;
''')
    ...
    _''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 335, col 6.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 335, col 14
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 335, col 14.
            write('''_error = _''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 335, col 36
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 335, col 36.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 335, col 44
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 335, col 44.
            write('''_timestep_error(_''')
            _v = VFFSL(SL,"stepper.errorFieldName",True) # u'${stepper.errorFieldName}' on line 335, col 73
            if _v is not None: write(_filter(_v, rawExpr='${stepper.errorFieldName}')) # from line 335, col 73.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 335, col 99
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 335, col 99.
            write(''');
    if (_''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 336, col 10
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 336, col 10.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 336, col 18
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 336, col 18.
            write('''_error > _error)
      _error = _''')
            _v = VFFSL(SL,"name",True) # u'${name}' on line 337, col 17
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 337, col 17.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 337, col 25
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 337, col 25.
            write('''_error;
''')
        write('''    
    _attempted_steps++;
...
''')
      ...
      ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('adaptiveStepSucceeded', $featureOrderingForToleranceChecking), autoIndent=True}")) # from line 344, col 7.
        write('''      _''')
      ...
      ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('adaptiveStepFailed', $featureOrderingForToleranceChecking), autoIndent=True}")) # from line 352, col 7.
        write('''      ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 353, col 7
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 353, col 7.
        write(''' -= _step;
...
''')
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 355, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 356, col 12.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 356, col 20
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 356, col 20.
            write('''_reset(_''')
            _v = VFFSL(SL,"stepper.resetFieldName",True) # u'${stepper.resetFieldName}' on line 356, col 40
            if _v is not None: write(_filter(_v, rawExpr='${stepper.resetFieldName}')) # from line 356, col 40.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 356, col 66
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 356, col 66.
            write(''') == false) {
        ...
        _LOG(_WARNING_LOG_LEVEL, "WARNING: NaN present. Integration halted at ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 358, col 79.
            write(''' = %e.\\n"
                           "         Non-finite number in integration vector \\"''')
            _v = VFFSL(SL,"vector.name",True) # u'${vector.name}' on line 359, col 80
            if _v is not None: write(_filter(_v, rawExpr='${vector.name}')) # from line 359, col 80.
            write('''\\" in segment ''')
            _v = VFFSL(SL,"segmentNumber",True) # u'${segmentNumber}' on line 359, col 108
            if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 359, col 108.
            write('''.\\n", ''')
            _v = VFFSL(SL,"propagationDimension",True) # u'$propagationDimension' on line 359, col 130
            if _v is not None: write(_filter(_v, rawExpr='$propagationDimension')) # from line 359, col 130.
            write(''');
        ''')
            _v = VFFSL(SL,"earlyTerminationCode",True) # u'${earlyTerminationCode, autoIndent=True}' on line 360, col 9
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${earlyTerminationCode, autoIndent=True}')) # from line 360, col 9.
            write('''      }
''')
        write('''
      ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${functions['ipEvolve'].call(_exponent = -1, parentFunction=function)}")) # from line 364, col 7.
        write('''
    ...
    if (_error < 0.5*_tolerance || _error > _tolerance) {
      ...
      real _scalingFactor = _safetyFactor * pow(abs(_error/_tolerance), real(-0.7/''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrationOrder}')) # from line 376, col 83.
        write(''')) * pow(_last_norm_error, real(0.4/''')
        _v = VFFSL(SL,"integrationOrder",True) # u'${integrationOrder}' on line 376, col 138
        if _v is not None: write(_filter(_v, rawExpr='${integrationOrder}')) # from line 376, col 138.
        write("""));
      ...
      if (_error > _tolerance && _scalingFactor > 1.0) {
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrationOrder}')) # from line 381, col 80.
        write('''));
      }
      _old_step = _step;
      _last_norm_error = pow(_safetyFactor/_scalingFactor*pow(_last_norm_error, real(0.4/''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrationOrder}')) # from line 384, col 90.
        write(''')), real(''')
        _v = VFFSL(SL,"integrationOrder",True) # u'${integrationOrder}' on line 384, col 118
        if _v is not None: write(_filter(_v, rawExpr='${integrationOrder}')) # from line 384, col 118.
        write('''/0.7));
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${postSingleStep, autoIndent=True}')) # from line 389, col 3.
        write('''  
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('integrateAdaptiveStepOuterLoopEnd', featureOrderingOuterLoop), autoIndent=True}")) # from line 391, col 3.
        write('''} while (!_next_sample_flag[''')
        _v = VFFSL(SL,"momentGroupCount",True) + 1 # u'${momentGroupCount + 1}' on line 392, col 29
        if _v is not None: write(_filter(_v, rawExpr='${momentGroupCount + 1}')) # from line 392, col 29.
        write(''']);

''')
        _v = VFFSL(SL,"localFinalise",True) # u'${localFinalise}' on line 394, col 1
        if _v is not None: write(_filter(_v, rawExpr='${localFinalise}')) # from line 394, col 1.
        _v = VFFSL(SL,"finalise",True) # u'${finalise}' on line 395, col 1
        if _v is not None: write(_filter(_v, rawExpr='${finalise}')) # from line 395, col 1.
        _v = VFFSL(SL,"free",True) # u'${free}' on line 396, col 1
        if _v is not None: write(_filter(_v, rawExpr='${free}')) # from line 396, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('integrateAdaptiveStepEnd', featureOrderingOuter)}")) # from line 398, col 1.
        write('''
_LOG(_SEGMENT_LOG_LEVEL, "Segment ''')
        _v = VFFSL(SL,"segmentNumber",True) # u'${segmentNumber}' on line 400, col 35
        if _v is not None: write(_filter(_v, rawExpr='${segmentNumber}')) # from line 400, col 35.
