...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${initialiseCrossPropagationFunctionImplementation}')) # from line 43, col 1.
            write('''
''')
        # 
...
_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 58, col 2.
            write('''_initialise_cross_propagation();
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${integrationDimRep.type}')) # from line 66, col 1.
            write(''' ''')
            _v = VFFSL(SL,"integrationDimRep.name",True) # u'${integrationDimRep.name}' on line 66, col 27
            if _v is not None: write(_filter(_v, rawExpr='${integrationDimRep.name}')) # from line 66, col 27.
            write(''' = ''')
            _v = VFFSL(SL,"initialValue",True) # u'${initialValue}' on line 66, col 55
            if _v is not None: write(_filter(_v, rawExpr='${initialValue}')) # from line 66, col 55.
            write(''';
''')
        # 
    ...
    def createStepVariable(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${step}')) # from line 78, col 14.
        write(''';
real _noiseStep = ''')
        _v = VFFSL(SL,"step",True) # u'${step}' on line 79, col 19
        if _v is not None: write(_filter(_v, rawExpr='${step}')) # from line 79, col 19.
        write(''';
''')
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('createFixedStepVariable', featureOrdering)}")) # from line 83, col 1.
        # 
    ...
    def segmentFunctionBody(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${createStepVariable}')) # from line 90, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('integrateFixedStepBegin', featureOrderingOuter)}")) # from line 93, col 1.
        write('''
''')
        _v = VFFSL(SL,"allocate",True) # u'${allocate}' on line 95, col 1
        if _v is not None: write(_filter(_v, rawExpr='${allocate}')) # from line 95, col 1.
        _v = VFFSL(SL,"initialise",True) # u'${initialise}' on line 96, col 1
        if _v is not None: write(_filter(_v, rawExpr='${initialise}')) # from line 96, col 1.
        _v = VFFSL(SL,"localInitialise",True) # u'${localInitialise}' on line 97, col 1
        if _v is not None: write(_filter(_v, rawExpr='${localInitialise}')) # from line 97, col 1.
        write('''
for (long _istep = 0; _istep < ''')
        _v = VFFSL(SL,"stepCount",True) # u'${stepCount}' on line 99, col 32
        if _v is not None: write(_filter(_v, rawExpr='${stepCount}')) # from line 99, col 32.
        write('''; _istep++) {
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('integrateFixedStepInnerLoopBegin', featureOrderingInner, dict), autoIndent=True}")) # from line 104, col 3.
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${preSingleStep, autoIndent=True, extraIndent=extraIndent}')) # from line 107, col 3.
        write('''  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${stepper.singleIntegrationStep(function), autoIndent=True, extraIndent=extraIndent}')) # from line 108, col 3.
        write('''  ''')
        _v = VFFSL(SL,"postSingleStep",True) # u'${postSingleStep, autoIndent=True, extraIndent=extraIndent}' on line 109, col 3
        if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${postSingleStep, autoIndent=True, extraIndent=extraIndent}')) # from line 109, col 3.
        write('''  
''')
        if VFFSL(SL,"cross",True): # generated from line 111, col 3
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, extraIndent=extraIndent, rawExpr='${copyResultIntoIntegrationArrays, autoIndent=True, extraIndent=extraIndent}')) # from line 114, col 3.
            write('''  
''')
        # 
        write('''  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('integrateFixedStepInnerLoopEnd', featureOrderingInner, dict), autoIndent=True}")) # from line 118, col 3.
        write('''}

''')
        _v = VFFSL(SL,"localFinalise",True) # u'${localFinalise}' on line 121, col 1
        if _v is not None: write(_filter(_v, rawExpr='${localFinalise}')) # from line 121, col 1.
        _v = VFFSL(SL,"finalise",True) # u'${finalise}' on line 122, col 1
        if _v is not None: write(_filter(_v, rawExpr='${finalise}')) # from line 122, col 1.
        _v = VFFSL(SL,"free",True) # u'${free}' on line 123, col 1
        if _v is not None: write(_filter(_v, rawExpr='${free}')) # from line 123, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('integrateFixedStepEnd', featureOrderingOuter)}")) # from line 125, col 1.
        # 
    ...
    def reducedFieldCopy(self, vectorMap, templateString, positiveIndexOverride=None, negativeIndexOverride=None, **KWS):
        ...
        indexOverrides = {VFFSL(SL,"propagationDimension",True): dict([(v.field, indexOverrideValue) for v in list(vectorMap.values())])}
        # 
        setOfVectorsToLoopOver = set(vectorMap.keys())
        setOfVectorsToLoopOver.update(list(vectorMap.values()))
        # 
        ...
        for reducedVector, vector in VFN(VFFSL(SL,"vectorMap",True),"iteritems",False)(): # generated from line 158, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 166, col 33.
            write('''_ncomponents; _icomp++) {
  ''')
            _v = VFFSL(SL,"innerLoopTemplate",True) # u'${innerLoopTemplate, autoIndent=True}' on line 167, col 3
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${innerLoopTemplate, autoIndent=True}')) # from line 167, col 3.
            write('''}
''')
    ...
    def initialiseCrossPropagationFunctionImplementation(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 188, col 7.
        write('''_initialise_cross_propagation()
{
''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${transformVectorsToBasis(vectorsNeedingTransforms, basis), autoIndent=True}')) # from line 201, col 3.
        write('''  
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$propagationDimension')) # from line 208, col 8.
        write(''' = ''')
        _v = VFFSL(SL,"propDimRep.arrayName",True) # u'${propDimRep.arrayName}' on line 208, col 32
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.arrayName}')) # from line 208, col 32.
        write('''[''')
        _v = VFFSL(SL,"index",True) # u'$index' on line 208, col 56
        if _v is not None: write(_filter(_v, rawExpr='$index')) # from line 208, col 56.
        write('''];
...
""", positiveIndexOverride = VFFSL(SL,"positiveIndexOverride",True), negativeIndexOverride = VFFSL(SL,"negativeIndexOverride",True))
        ...
        for reducedVector in VFN(VFFSL(SL,"combinedLoopVectorMap",True),"keys",False)(): # generated from line 215, col 5
            if VFFSL(SL,"reducedVector.needsTransforms",True): # generated from line 216, col 7
                ...
                if _v is not None: write(_filter(_v, rawExpr='${reducedVector.id}')) # from line 217, col 8.
                write('''_basis = ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$basisIndexForBasis($reducedVector.field.basisForBasis($basis))')) # from line 217, col 36.
                write('''; 
''')
        write('''  }
...
''')
        ...
        write('''  // Set the boundary condition
  {
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${parent.codeBlocks['boundaryCondition'].loop(self.boundaryConditionCode), autoIndent=True}")) # from line 225, col 5.
        write('''  }
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${codeString}')) # from line 242, col 1.
        write('''// **********************************************
''')
        # 
