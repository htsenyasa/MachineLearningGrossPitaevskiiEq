...
class HermiteGaussTransform(_HermiteGaussTransform):
    ...
    def globalsForDim(self, dimName, basisDict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${dimName}')) # from line 27, col 27.
        write('''[] = {''')
        _v = VFFSL(SL,"wrapArray",False)(VFFSL(SL,"hermiteZeros",False)(lattice)) # u'${wrapArray($hermiteZeros(lattice))}' on line 27, col 43
        if _v is not None: write(_filter(_v, rawExpr='${wrapArray($hermiteZeros(lattice))}')) # from line 27, col 43.
        write('''};
const real _hermite_gauss_weights_''')
        _v = VFFSL(SL,"dimName",True) # u'${dimName}' on line 28, col 35
        if _v is not None: write(_filter(_v, rawExpr='${dimName}')) # from line 28, col 35.
        write('''[] = {''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${wrapArray($hermiteGaussWeights(lattice))}')) # from line 28, col 51.
        write('''};
''')
        # 
