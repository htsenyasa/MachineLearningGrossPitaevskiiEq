...
ptrdiff_t _block_size = (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.globalLattice}')) # from line 30, col 26.
        write('''-1)/_size + 1;
''')
        _v = VFFSL(SL,"mpiDimRep.localOffset",True) # u'${mpiDimRep.localOffset}' on line 31, col 1
        if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localOffset}')) # from line 31, col 1.
        write(''' = _rank * _block_size;
if (_rank != _size - 1)
  ''')
        _v = VFFSL(SL,"mpiDimRep.localLattice",True) # u'${mpiDimRep.localLattice}' on line 33, col 3
        if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localLattice}')) # from line 33, col 3.
        write(""" = _block_size;
else {
  ...
  """)
        ...
        if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localLattice}')) # from line 38, col 3.
        write(''' = MAX(''')
        _v = VFFSL(SL,"mpiDimRep.globalLattice",True) # u'${mpiDimRep.globalLattice}' on line 38, col 35
        if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.globalLattice}')) # from line 38, col 35.
...
''')
        for field in VFFSL(SL,"fields",True): # generated from line 41, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${field.name}')) # from line 48, col 62.
            write("""' field.
ptrdiff_t _""")
            _v = VFFSL(SL,"field.name",True) # u'${field.name}' on line 49, col 12
            if _v is not None: write(_filter(_v, rawExpr='${field.name}')) # from line 49, col 12.
            write('''_skip_size = ''')
            _v = VFFSL(SL,"mpiDimRep.globalLattice",True) # u'${mpiDimRep.globalLattice}' on line 49, col 38
            if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.globalLattice}')) # from line 49, col 38.
            write('''/''')
            _v = VFFSL(SL,"fieldMPIDimRep.globalLattice",True) # u'${fieldMPIDimRep.globalLattice}' on line 49, col 65
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.globalLattice}')) # from line 49, col 65.
            write(''';
if (_rank == 0) {
  ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localOffset",True) # u'${fieldMPIDimRep.localOffset}' on line 51, col 3
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localOffset}')) # from line 51, col 3.
            write(''' = 0;
  ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localLattice",True) # u'${fieldMPIDimRep.localLattice}' on line 52, col 3
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localLattice}')) # from line 52, col 3.
            write(''' = (''')
            _v = VFFSL(SL,"mpiDimRep.localLattice",True) # u'${mpiDimRep.localLattice}' on line 52, col 37
            if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localLattice}')) # from line 52, col 37.
            write('''-1)/_''')
            _v = VFFSL(SL,"field.name",True) # u'${field.name}' on line 52, col 67
            if _v is not None: write(_filter(_v, rawExpr='${field.name}')) # from line 52, col 67.
            write('''_skip_size + 1;
} else {
  ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localOffset",True) # u'${fieldMPIDimRep.localOffset}' on line 54, col 3
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localOffset}')) # from line 54, col 3.
            write(''' = (''')
            _v = VFFSL(SL,"mpiDimRep.localOffset",True) # u'${mpiDimRep.localOffset}' on line 54, col 36
            if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localOffset}')) # from line 54, col 36.
            write('''-1)/_''')
            _v = VFFSL(SL,"field.name",True) # u'${field.name}' on line 54, col 65
            if _v is not None: write(_filter(_v, rawExpr='${field.name}')) # from line 54, col 65.
            write('''_skip_size + 1;
  ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localLattice",True) # u'${fieldMPIDimRep.localLattice}' on line 55, col 3
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localLattice}')) # from line 55, col 3.
            write(''' = MIN((''')
            _v = VFFSL(SL,"mpiDimRep.localOffset",True) # u'${mpiDimRep.localOffset}' on line 55, col 41
            if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localOffset}')) # from line 55, col 41.
            write(''' + ''')
            _v = VFFSL(SL,"mpiDimRep.localLattice",True) # u'${mpiDimRep.localLattice}' on line 55, col 68
            if _v is not None: write(_filter(_v, rawExpr='${mpiDimRep.localLattice}')) # from line 55, col 68.
            write(''' - 1)/_''')
            _v = VFFSL(SL,"field.name",True) # u'${field.name}' on line 55, col 100
            if _v is not None: write(_filter(_v, rawExpr='${field.name}')) # from line 55, col 100.
            write('''_skip_size
                                         + 1 - ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localOffset",True) # u'${fieldMPIDimRep.localOffset}' on line 56, col 48
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localOffset}')) # from line 56, col 48.
            write(''', MAX(''')
            _v = VFFSL(SL,"fieldMPIDimRep.globalLattice",True) # u'${fieldMPIDimRep.globalLattice}' on line 56, col 83
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.globalLattice}')) # from line 56, col 83.
            write(''' - ''')
            _v = VFFSL(SL,"fieldMPIDimRep.localOffset",True) # u'${fieldMPIDimRep.localOffset}' on line 56, col 117
            if _v is not None: write(_filter(_v, rawExpr='${fieldMPIDimRep.localOffset}')) # from line 56, col 117.
            write(''', 0));
}
