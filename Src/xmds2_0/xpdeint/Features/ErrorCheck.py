...
real* _''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupOutputField.name}')) # from line 36, col 8.
            write('''_fullstep;
''')
        # 
...
_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupOutputField.name}')) # from line 52, col 2.
            write('''_fullstep = _''')
            _v = VFFSL(SL,"momentGroup.processedVector.id",True) # u'${momentGroup.processedVector.id}' on line 52, col 45
            if _v is not None: write(_filter(_v, rawExpr='${momentGroup.processedVector.id}')) # from line 52, col 45.
            write(''';
// _''')
            _v = VFFSL(SL,"momentGroupOutputField.name",True) # u'${momentGroupOutputField.name}' on line 53, col 5
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupOutputField.name}')) # from line 53, col 5.
...
''')
    ...
    _active_''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${momentGroup.processedVector.id}')) # from line 64, col 13.
            write(''' = _''')
            _v = VFFSL(SL,"momentGroupOutputField.name",True) # u'${momentGroupOutputField.name}' on line 64, col 50
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupOutputField.name}')) # from line 64, col 50.
            write('''_fullstep;
''')
        write('''  }
  else {
...
''')
            for aliasName in momentGroup.processedVector.aliases: # generated from line 73, col 5
                if not aliasName==''.join(['_',str(VFFSL(SL,"momentGroupOutputField.name",True)),'_halfstep']): # generated from line 74, col 7
                    write('''    _active_''')
                    _v = VFFSL(SL,"momentGroup.processedVector.id",True) # u'${momentGroup.processedVector.id}' on line 75, col 13
                    if _v is not None: write(_filter(_v, rawExpr='${momentGroup.processedVector.id}')) # from line 75, col 13.
                    write(''' = ''')
                    _v = VFFSL(SL,"aliasName",True) # u'$aliasName' on line 75, col 49
                    if _v is not None: write(_filter(_v, rawExpr='$aliasName')) # from line 75, col 49.
                    write(''';
    ''')
                    ...
                    if _v is not None: write(_filter(_v, rawExpr="${momentGroup.processedVector.functions['initialise'].call()}")) # from line 76, col 5.
                    write('''
''')
            write('''    
    _active_''')
            _v = VFFSL(SL,"momentGroup.processedVector.id",True) # u'${momentGroup.processedVector.id}' on line 80, col 13
            if _v is not None: write(_filter(_v, rawExpr='${momentGroup.processedVector.id}')) # from line 80, col 13.
            write(''' = _''')
            _v = VFFSL(SL,"momentGroupOutputField.name",True) # u'${momentGroupOutputField.name}' on line 80, col 50
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupOutputField.name}')) # from line 80, col 50.
            write('''_halfstep;
''')
        write('''  }
...
_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${fieldName}')) # from line 115, col 2.
        write('''_fullstep[$index] = _''')
        _v = VFFSL(SL,"fieldName",True) # u'${fieldName}' on line 115, col 36
        if _v is not None: write(_filter(_v, rawExpr='${fieldName}')) # from line 115, col 36.
        write('''_fullstep[$index] - _''')
        _v = VFFSL(SL,"fieldName",True) # u'${fieldName}' on line 115, col 70
        if _v is not None: write(_filter(_v, rawExpr='${fieldName}')) # from line 115, col 70.
...
''')
    ...
    def writeOutFunctionImplementationBody(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${processedVector.id}')) # from line 156, col 9.
        write(''' = _''')
        _v = VFFSL(SL,"outputFieldName",True) # u'${outputFieldName}' on line 156, col 34
        if _v is not None: write(_filter(_v, rawExpr='${outputFieldName}')) # from line 156, col 34.
        write('''_fullstep;
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${processedVector.findMaximum('_max_step_error', basis = momentGroup.outputBasis)}")) # from line 158, col 1.
        write('''
// Restore active pointer for processed vector
_active_''')
        _v = VFFSL(SL,"processedVector.id",True) # u'${processedVector.id}' on line 161, col 9
        if _v is not None: write(_filter(_v, rawExpr='${processedVector.id}')) # from line 161, col 9.
        write(''' = _''')
        _v = VFFSL(SL,"outputFieldName",True) # u'${outputFieldName}' on line 161, col 34
        if _v is not None: write(_filter(_v, rawExpr='${outputFieldName}')) # from line 161, col 34.
        write('''_halfstep;
...
_LOG(_SIMULATION_LOG_LEVEL, "Maximum step error in moment group ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${momentGroup.number+1}')) # from line 163, col 65.
        write(''' was %e\\n", _max_step_error);
''')
