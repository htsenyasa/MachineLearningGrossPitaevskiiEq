...
''')
        ...
        for integrationVector in integrator.integrationVectors: # generated from line 37, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${separator}')) # from line 43, col 1.
            write('''_xmds_isnonfinite(_active_''')
            _v = VFFSL(SL,"integrationVector.id",True) # u'${integrationVector.id}' on line 43, col 39
            if _v is not None: write(_filter(_v, rawExpr='${integrationVector.id}')) # from line 43, col 39.
            write('''[0]''')
            _v = VFFSL(SL,"suffix",True) # u'${suffix}' on line 43, col 65
            if _v is not None: write(_filter(_v, rawExpr='${suffix}')) # from line 43, col 65.
            write(''')''')
            separator = ' || '
        write(''') {
  ...
  _LOG(_WARNING_LOG_LEVEL, "WARNING: halt_non_finite: Integration halted at ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.propagationDimension}')) # from line 50, col 77.
        write(''' = %e.\\n"
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.segmentNumber}')) # from line 51, col 89.
        write('''.\\n", ''')
        _v = VFFSL(SL,"propagationDimension",True) # u'$propagationDimension' on line 51, col 122
        if _v is not None: write(_filter(_v, rawExpr='$propagationDimension')) # from line 51, col 122.
        write(''');
  
  ''')
        _v = VFFSL(SL,"integrator.earlyTerminationCode",True) # u'${integrator.earlyTerminationCode, autoIndent=True}' on line 53, col 3
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${integrator.earlyTerminationCode, autoIndent=True}')) # from line 53, col 3.
        write('''}
''')
        # 
