...
''')
    ...
    def functionImplementations(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${writeOutFunctionImplementation}')) # from line 45, col 1.
        # 
        ...
        write('''void _write_output()
{
  _LOG(_SIMULATION_LOG_LEVEL, "Generating output for ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${simulationName}')) # from line 52, col 54.
        write('''\\n");
...
''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('writeOutBegin', featureOrdering), autoIndent=True}")) # from line 58, col 3.
            write('''  
  ''')
            _v = VFN(VFFSL(SL,"outputFormat",True),"writeOutSetup",False)(''.join(['("',str(VFFSL(SL,"filename",True)),'" + gsArgsAndValues).c_str()']), self) # u'${outputFormat.writeOutSetup(c\'("${filename}" + gsArgsAndValues).c_str()\', self), autoIndent=True}' on line 60, col 3
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${outputFormat.writeOutSetup(c\'("${filename}" + gsArgsAndValues).c_str()\', self), autoIndent=True}')) # from line 60, col 3.
            for momentGroup in VFFSL(SL,"momentGroups",True): # generated from line 61, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr="${momentGroup.functions['writeOut'].call(_outfile = '_outfile')}")) # from line 62, col 3.
                write('''
''')
            write('''  
  ''')
            _v = VFFSL(SL,"outputFormat.writeOutTearDown",True) # u'${outputFormat.writeOutTearDown, autoIndent=True}' on line 65, col 3
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${outputFormat.writeOutTearDown, autoIndent=True}')) # from line 65, col 3.
            write('''  
  ''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('writeOutEnd', featureOrdering), autoIndent=True}")) # from line 67, col 3.
        write('''}
''')
    ...
    def writeOutFunctionImplementationBody(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${outputFormat.writeOutFunctionImplementationBody(dict)}')) # from line 75, col 1.
    ...
    def integrateFixedStepInnerLoopEnd(self, dict, **KWS):
        ...
        for momentGroupNumber, sampleCount in enumerate(VFFSL(SL,"integrator.samples",True)): # generated from line 88, col 3
            if VFFSL(SL,"sampleCount",True) > 0: # generated from line 89, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='$sampleEveryNthStep')) # from line 92, col 15.
                write(''') == ''')
                _v = VFFSL(SL,"sampleEveryNthStep",True) - 1 # u'${sampleEveryNthStep - 1}' on line 92, col 39
                if _v is not None: write(_filter(_v, rawExpr='${sampleEveryNthStep - 1}')) # from line 92, col 39.
                write(''')
  _mg''')
                _v = VFFSL(SL,"momentGroupNumber",True) # u'${momentGroupNumber}' on line 93, col 6
                if _v is not None: write(_filter(_v, rawExpr='${momentGroupNumber}')) # from line 93, col 6.
                write('''_sample();
''')
        # 
...
''')
        for momentGroupNumber, sampleCount in enumerate(VFFSL(SL,"integrator.samples",True)): # generated from line 105, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 106, col 25.
            write(''']) {
    _mg''')
            _v = VFFSL(SL,"momentGroupNumber",True) # u'${momentGroupNumber}' on line 107, col 8
            if _v is not None: write(_filter(_v, rawExpr='${momentGroupNumber}')) # from line 107, col 8.
            write('''_sample();
    _next_sample_counter[''')
            _v = VFFSL(SL,"momentGroupNumber",True) # u'$momentGroupNumber' on line 108, col 26
            if _v is not None: write(_filter(_v, rawExpr='$momentGroupNumber')) # from line 108, col 26.
            write(''']++;
  }
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${momentGroupCount}')) # from line 112, col 25.
        write('''])
    _next_sample_flag[''')
        _v = VFFSL(SL,"momentGroupCount",True) + 1 # u'${momentGroupCount + 1}' on line 113, col 23
        if _v is not None: write(_filter(_v, rawExpr='${momentGroupCount + 1}')) # from line 113, col 23.
        write('''] = true;
  else {
    _break_next = false;
    _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 116, col 6
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 116, col 6.
        write('''_break_next = _''')
        _v = VFFSL(SL,"integrator.name",True) # u'${integrator.name}' on line 116, col 44
        if _v is not None: write(_filter(_v, rawExpr='${integrator.name}')) # from line 116, col 44.
...
if ( (_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 120, col 8.
        write('''_local + _step)*(1.0 + _EPSILON) > _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 120, col 67
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 120, col 67.
        write('''_break_next) {
  _break_next = true;
  _LOG(_SAMPLE_LOG_LEVEL, "Current timestep: %e\\n", _old_step);
  _step = _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 123, col 12
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 123, col 12.
        write('''_break_next - _''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 123, col 50
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 123, col 50.
        write('''_local;
}
''')
