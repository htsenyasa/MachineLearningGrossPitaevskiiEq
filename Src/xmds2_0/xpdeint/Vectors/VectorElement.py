...
class VectorElement(_VectorElement):
    ...
    def description(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 27, col 26.
    ...
    def defines(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 36, col 11.
        write(''' defines
#define _''')
        _v = VFFSL(SL,"id",True) # u'${id}' on line 37, col 10
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 37, col 10.
        write('''_ncomponents ''')
        _v = VFFSL(SL,"nComponents",True) # u'$nComponents' on line 37, col 28
        if _v is not None: write(_filter(_v, rawExpr='$nComponents')) # from line 37, col 28.
        write('''
''')
        # 
    ...
    def globals(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 48, col 11.
        write(''' globals
size_t ''')
        _v = VFFSL(SL,"allocSize",True) # u'${allocSize}' on line 49, col 8
        if _v is not None: write(_filter(_v, rawExpr='${allocSize}')) # from line 49, col 8.
        write(''' = 0;
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 50, col 9.
        write(''' = NULL;
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 51, col 16.
        write(''' = NULL;
''')
        for aliasName in VFFSL(SL,"aliases",True): # generated from line 52, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${aliasName}')) # from line 53, col 8.
            write(''' = NULL;
''')
        # 
...
ptrdiff_t _''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 58, col 12.
            write('''_basis = -1;
''')
        # 
...
bzero(_active_""")
            ...
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 70, col 15.
            write(''', sizeof(''')
            _v = VFFSL(SL,"type",True) # u'${type}' on line 70, col 29
            if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 70, col 29.
            write(''') * ''')
            _v = VFFSL(SL,"allocSize",True) # u'${allocSize}' on line 70, col 40
            if _v is not None: write(_filter(_v, rawExpr='${allocSize}')) # from line 70, col 40.
            write(''');
''')
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${initialiser.initialiseVector}')) # from line 74, col 1.
        if VFFSL(SL,"needsTransforms",True): # generated from line 76, col 3
            write('''
_''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 78, col 2
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 78, col 2.
            write('''_basis = ''')
            _v = VFFSL(SL,"basisIndexForBasis",False)(self.initialBasis) # u'$basisIndexForBasis(self.initialBasis)' on line 78, col 16
            if _v is not None: write(_filter(_v, rawExpr='$basisIndexForBasis(self.initialBasis)')) # from line 78, col 16.
            write(''';
''')
        # 
    ...
    def basisTransformFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('basisTransformFunctionContentsBegin', featureOrdering, dict)}")) # from line 87, col 1.
        # 
    ...
    def initialise(self, **KWS):
        ...
        if VFFSL(SL,"needsInitialisation",True): # generated from line 96, col 3
            for aliasName in VFFSL(SL,"aliases",True): # generated from line 97, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 98, col 9.
                write(''' = ''')
                _v = VFFSL(SL,"aliasName",True) # u'$aliasName' on line 98, col 17
                if _v is not None: write(_filter(_v, rawExpr='$aliasName')) # from line 98, col 17.
                write(''';
''')
                _v = VFN(VFFSL(SL,"functions",True)['initialise'],"call",False)() # u"${functions['initialise'].call()}" on line 99, col 1
                if _v is not None: write(_filter(_v, rawExpr="${functions['initialise'].call()}")) # from line 99, col 1.
                write('''
''')
            write('''_active_''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 101, col 9
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 101, col 9.
            write(''' = _''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 101, col 18
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 101, col 18.
            write(''';
''')
            _v = VFN(VFFSL(SL,"functions",True)['initialise'],"call",False)() # u"${functions['initialise'].call()}" on line 102, col 1
            if _v is not None: write(_filter(_v, rawExpr="${functions['initialise'].call()}")) # from line 102, col 1.
            write('''
''')
        # 
...
_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 112, col 2.
        write(''' = (''')
        _v = VFFSL(SL,"type",True) # u'$type' on line 112, col 11
        if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 112, col 11.
        write('''*) xmds_malloc(sizeof(''')
        _v = VFFSL(SL,"type",True) # u'${type}' on line 112, col 38
        if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 112, col 38.
        write(''') * MAX(''')
        _v = VFFSL(SL,"allocSize",True) # u'${allocSize}' on line 112, col 53
        if _v is not None: write(_filter(_v, rawExpr='${allocSize}')) # from line 112, col 53.
        write(''',1));
_active_''')
        _v = VFFSL(SL,"id",True) # u'${id}' on line 113, col 9
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 113, col 9.
        write(''' = _''')
        _v = VFFSL(SL,"id",True) # u'${id}' on line 113, col 18
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 113, col 18.
        write(''';
''')
        for aliasName in VFFSL(SL,"aliases",True): # generated from line 114, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$aliasName')) # from line 115, col 1.
            write(''' = (''')
            _v = VFFSL(SL,"type",True) # u'$type' on line 115, col 15
            if _v is not None: write(_filter(_v, rawExpr='$type')) # from line 115, col 15.
            write('''*) xmds_malloc(sizeof(''')
            _v = VFFSL(SL,"type",True) # u'${type}' on line 115, col 42
            if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 115, col 42.
            write(''') * MAX(''')
            _v = VFFSL(SL,"allocSize",True) # u'${allocSize}' on line 115, col 57
            if _v is not None: write(_filter(_v, rawExpr='${allocSize}')) # from line 115, col 57.
            write(''',1)); // alias for _''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 115, col 89
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 115, col 89.
            write('''
''')
...
xmds_free(_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 121, col 12.
        write(''');
_active_''')
        _v = VFFSL(SL,"id",True) # u'${id}' on line 122, col 9
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 122, col 9.
        write(''' = _''')
        _v = VFFSL(SL,"id",True) # u'${id}' on line 122, col 18
        if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 122, col 18.
        write(''' = NULL;
''')
        for aliasName in VFFSL(SL,"aliases",True): # generated from line 123, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$aliasName')) # from line 124, col 11.
            write('''); // alias for _''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 124, col 38
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 124, col 38.
            write('''
''')
            _v = VFFSL(SL,"aliasName",True) # u'${aliasName}' on line 125, col 1
            if _v is not None: write(_filter(_v, rawExpr='${aliasName}')) # from line 125, col 1.
            write(''' = NULL;
''')
    ...
    def findMaximum(self, variableName, basis=None, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${variableName}')) # from line 130, col 6.
        write(''' = 0.0;
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${modFunction}')) # from line 138, col 22.
        write('''(_active_${vector.id}[${index}]);
if (_current_size > ''')
        _v = VFFSL(SL,"variableName",True) # u'$variableName' on line 139, col 21
        if _v is not None: write(_filter(_v, rawExpr='$variableName')) # from line 139, col 21.
        write(''') // UNVECTORISABLE
  ''')
        _v = VFFSL(SL,"variableName",True) # u'${variableName}' on line 140, col 3
        if _v is not None: write(_filter(_v, rawExpr='${variableName}')) # from line 140, col 3.
        write(''' = _current_size;
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${loopOverVectorsWithInnerContentTemplate([self], loopContents, basis = basis)}')) # from line 142, col 1.
        if VFFSL(SL,"type",True) == 'complex': # generated from line 143, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variableName}')) # from line 144, col 1.
            write(''' = sqrt(''')
            _v = VFFSL(SL,"variableName",True) # u'${variableName}' on line 144, col 24
            if _v is not None: write(_filter(_v, rawExpr='${variableName}')) # from line 144, col 24.
            write('''); // Take the square root to find the modulus.
''')
        _v = VFFSL(SL,"insertCodeForFeatures",False)('findMax', ['Driver'], {'variable': ''.join(['&',str(VFFSL(SL,"variableName",True))]), 'count': '1'}) # u"${insertCodeForFeatures('findMax', ['Driver'], {'variable': c'&${variableName}', 'count': '1'})}" on line 146, col 1
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('findMax', ['Driver'], {'variable': c'&${variableName}', 'count': '1'})}")) # from line 146, col 1.
        # 
