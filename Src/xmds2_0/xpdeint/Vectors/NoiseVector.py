...
class NoiseVector(_NoiseVector):
    ...
    def description(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 27, col 32.
    ...
    def evaluateFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('evaluateNoiseVectorBegin', featureOrdering, featureDict)}")) # from line 39, col 1.
        ...
        if _v is not None: write(_filter(_v, extraIndent=extraIndent, rawExpr='${evaluateFunctionContentsInner(function), extraIndent=extraIndent}')) # from line 42, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('evaluateNoiseVectorEnd', featureOrdering, featureDict)}")) # from line 44, col 1.
        # 
        if VFFSL(SL,"needsTransforms",True): # generated from line 46, col 3
            write('''_''')
            _v = VFFSL(SL,"id",True) # u'${id}' on line 47, col 2
            if _v is not None: write(_filter(_v, rawExpr='${id}')) # from line 47, col 2.
            write('''_basis = ''')
            _v = VFFSL(SL,"basisIndexForBasis",False)(self.initialBasis) # u'$basisIndexForBasis(self.initialBasis)' on line 47, col 16
            if _v is not None: write(_filter(_v, rawExpr='$basisIndexForBasis(self.initialBasis)')) # from line 47, col 16.
            write(''';
''')
        # 
    ...
    def evaluateFunctionContentsInner(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${sizeInBasisInReals(self.initialBasis)}')) # from line 54, col 32.
        write(''';
''')
        _v = VFFSL(SL,"randomVariable.makeNoises",True) # u'${randomVariable.makeNoises}' on line 55, col 1
        if _v is not None: write(_filter(_v, rawExpr='${randomVariable.makeNoises}')) # from line 55, col 1.
        # 
    ...
    def splitFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('evaluateNoiseVectorBegin', featureOrdering, featureDict)}")) # from line 70, col 1.
        extraIndent = featureDict['extraIndent']
        # 
        ...
        if _v is not None: write(_filter(_v, extraIndent = extraIndent, rawExpr='${splitFunctionContentsInner(function), extraIndent = extraIndent}')) # from line 73, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('evaluateNoiseVectorEnd', featureOrdering, featureDict)}")) # from line 75, col 1.
        # 
...
''')
    ...
    def splitFunctionContentsInner(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${sizeInBasisInReals(self.initialBasis)}')) # from line 85, col 32.
        write(''';
''')
        _v = VFN(VFFSL(SL,"randomVariable",True),"splitNoise",False)(function) # u'${randomVariable.splitNoise(function)}' on line 86, col 1
        if _v is not None: write(_filter(_v, rawExpr='${randomVariable.splitNoise(function)}')) # from line 86, col 1.
        # 
