...
class ScriptElement(_ScriptElement):
    ...
    def loopOverVectorsWithInnerContentTemplate(self, vectors, templateString, basis=None, **KWS):
        ...
        for vector in VFFSL(SL,"vectors",True): # generated from line 148, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('loopOverVectorsWithInnerContentTemplateBegin', $loopFeatureOrdering, $dict)}")) # from line 155, col 1.
            ...
            if _v is not None: write(_filter(_v, rawExpr='${loopCountPrefix}')) # from line 162, col 26.
            _v = VFFSL(SL,"vectorSize",True) # u'${vectorSize}' on line 162, col 44
            if _v is not None: write(_filter(_v, rawExpr='${vectorSize}')) # from line 162, col 44.
            write('''; _i0++) {
  ''')
            _v = VFFSL(SL,"innerLoopTemplate",True) # u'${innerLoopTemplate, autoIndent=True}' on line 163, col 3
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${innerLoopTemplate, autoIndent=True}')) # from line 163, col 3.
            write('''}
''')
            ...
            if _v is not None: write(_filter(_v, extraIndent=dict['extraIndent'], rawExpr="${loopString, extraIndent=dict['extraIndent']}")) # from line 166, col 1.
            write('''
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('loopOverVectorsWithInnerContentTemplateEnd', $loopFeatureOrdering, $dict)}")) # from line 167, col 1.
    ...
    def loopOverVectorsInBasisWithInnerContent(self, vectors, basis, innerContent, **KWS):
        ...
        for vector in VFFSL(SL,"vectors",True): # generated from line 193, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${blankLineSeparator}')) # from line 195, col 1.
            blankLineSeparator = '\n'
            # 
            write('''long _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 198, col 7
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 198, col 7.
...
''')
            ...
            for componentNumber, componentName in enumerate(VFFSL(SL,"vector.components",True)): # generated from line 200, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='$componentName')) # from line 201, col 9.
                write(''' _active_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 201, col 32
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 201, col 32.
                write('''[_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 201, col 46
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 201, col 46.
                write('''_index_pointer + ''')
                _v = VFFSL(SL,"componentNumber",True) # u'$componentNumber' on line 201, col 75
                if _v is not None: write(_filter(_v, rawExpr='$componentNumber')) # from line 201, col 75.
                write(''']
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('loopOverVectorsWithInnerContentBegin', $featureOrdering, $dict)}")) # from line 205, col 1.
        write('''for (long _i0 = 0; _i0 < ''')
        _v = VFN(VFFSL(SL,"field",True),"sizeInBasis",False)(basis) # u'${field.sizeInBasis(basis)}' on line 206, col 26
        if _v is not None: write(_filter(_v, rawExpr='${field.sizeInBasis(basis)}')) # from line 206, col 26.
        write('''; _i0++) {
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeaturesInReverseOrder('loopOverVectorsWithInnerContentEnd', $featureOrdering, $dict), autoIndent=True}")) # from line 207, col 3.
        # 
        write('''  ''')
        _v = VFFSL(SL,"innerContent",True) # u'${innerContent, autoIndent=True}' on line 209, col 3
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${innerContent, autoIndent=True}')) # from line 209, col 3.
        write('''
''')
        for vector in VFFSL(SL,"vectors",True): # generated from line 211, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 212, col 4.
            write('''_index_pointer += _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 212, col 35
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 212, col 35.
            write('''_ncomponents;
''')
        write('''}
''')
        for vector in VFFSL(SL,"vectors",True): # generated from line 215, col 3
            for componentName in VFFSL(SL,"vector.components",True): # generated from line 216, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='$componentName')) # from line 217, col 8.
                write('''
''')
        # 
    ...
    def loopOverFieldInBasisWithVectorsAndInnerContent(self, field, basis, vectors, innerLoopCode, indexOverrides=None, vectorOverrides=None, loopingOrder=_ScriptElement.LoopingOrder.MemoryOrder, preDimensionLoopOpeningCode=None, postDimensionLoopClosingCode=None, vectorsNotNeedingDefines=None, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('loopOverFieldInBasisWithVectorsAndInnerContentBegin', featureOrdering, featuresDict)}")) # from line 291, col 1.
        # 
        ...
        for vector in VFFSL(SL,"vectors",True): # generated from line 309, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 311, col 7.
            write('''_index_pointer = 0;
''')
            if vector in vectorsNotNeedingDefines: # generated from line 312, col 5
                ...
                for componentName in vector.components: # generated from line 316, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$vector.type')) # from line 317, col 1.
                    write(''' ''')
                    _v = VFFSL(SL,"componentName",True) # u'$componentName' on line 317, col 14
                    if _v is not None: write(_filter(_v, rawExpr='$componentName')) # from line 317, col 14.
                    write(''';
''')
                ...
                for componentNumber, componentName in enumerate(VFFSL(SL,"vector.components",True)): # generated from line 321, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$componentName')) # from line 322, col 9.
                    write(''' _active_''')
                    _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 322, col 32
                    if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 322, col 32.
                    write('''[_''')
                    _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 322, col 46
                    if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 322, col 46.
                    write('''_index_pointer + ''')
                    _v = VFFSL(SL,"componentNumber",True) # u'$componentNumber' on line 322, col 75
                    if _v is not None: write(_filter(_v, rawExpr='$componentNumber')) # from line 322, col 75.
                    write(''']
''')
        ...
        for dimension in VFFSL(SL,"geometry.dimensions",True): # generated from line 328, col 3
            ...
            if dimRep.name in indexOverrides: # generated from line 338, col 5
                continue
            write('''
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.createCoordinateVariableForSinglePointSample}')) # from line 342, col 1.
            write('''
''')
        # 
        ...
        for dimRep in field.inBasis(basis): # generated from line 348, col 3
            ...
            if dimRep.name in preDimensionLoopOpeningCode: # generated from line 350, col 5
                ...
                if _v is not None: write(_filter(_v, extraIndent=VFFSL(SL,"indentLevel",True), rawExpr='${preDimensionLoopOpeningCode[$dimRep.name], extraIndent=$indentLevel}')) # from line 351, col 1.
            if dimRep.name not in indexOverrides: # generated from line 353, col 5
                ...
                if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr="${insertCodeForFeatures('loopOverFieldInBasisWithVectorsAndInnerContentLoopOpenBegin', loopOpeningFeatureOrdering, featuresDict), extraIndent=indentLevel}")) # from line 363, col 1.
                # 
                ...
                if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${dimRep.openLoop(loopingOrder=loopingOrder), extraIndent=indentLevel}')) # from line 365, col 1.
                ...
                if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr="${insertCodeForFeaturesInReverseOrder('loopOverFieldInBasisWithVectorsAndInnerContentLoopOpenEnd', loopOpeningFeatureOrdering, featuresDict), extraIndent=indentLevel}")) # from line 367, col 1.
                ...
                if _v is not None: write(_filter(_v, extraIndent=VFFSL(SL,"indentLevel",True), rawExpr='${prologueForOverriddenDimRepInFieldInBasisWithVectors($dimRep, $field, $basis, $vectors, $indexOverrides), extraIndent=$indentLevel}')) # from line 370, col 1.
            # 
        # 
        ...
        if result: # generated from line 376, col 3
            ...
            if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${result, extraIndent=indentLevel}')) # from line 377, col 1.
        # 
        _v = VFFSL(SL,"innerLoopCode",True) # u'${innerLoopCode, extraIndent=$indentLevel}' on line 380, col 1
        if _v is not None: write(_filter(_v, extraIndent=VFFSL(SL,"indentLevel",True), rawExpr='${innerLoopCode, extraIndent=$indentLevel}')) # from line 380, col 1.
        ...
        if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${epilogueToIntegrateOverriddenVectorsForSamplingFieldInBasis(vectorOverrides, field, basis), extraIndent=indentLevel}')) # from line 381, col 1.
        # 
        if lastLoopDimRep: # generated from line 383, col 3
            ...
            if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${incrementIndexPointersForVectorsWithFieldBasisAndLastLoopDimRep(vectorsNotRequiringExplicitIndexPointers, field, basis, lastLoopDimRep), extraIndent=indentLevel}')) # from line 386, col 1.
        # 
        ...
        for dimRep in reversed(field.inBasis(basis)): # generated from line 391, col 3
            ...
            if dimRep.name not in indexOverrides: # generated from line 394, col 5
                ...
                if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${dimRep.closeLoop(loopingOrder=loopingOrder), extraIndent=indentLevel}')) # from line 396, col 1.
            # 
            if VFFSL(SL,"dimRep.name",True) in postDimensionLoopClosingCode: # generated from line 399, col 5
                ...
                if _v is not None: write(_filter(_v, extraIndent=indentLevel, rawExpr='${postDimensionLoopClosingCode[dimRep.name], extraIndent=indentLevel}')) # from line 400, col 1.
            # 
        # 
        ...
        for vector in vectors: # generated from line 406, col 3
            ...
            for componentName in vector.components: # generated from line 410, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='$componentName')) # from line 411, col 8.
                write('''
''')
        ...
        for dimension in VFFSL(SL,"geometry.dimensions",True): # generated from line 416, col 3
            ...
            # 
            dimRep = dimension.inBasis(basis)
            if dimRep.name in indexOverrides: # generated from line 426, col 5
                continue
            write('''#undef d''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 429, col 9
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 429, col 9.
            write('''
''')
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('loopOverFieldInBasisWithVectorsAndInnerContentEnd', featureOrdering, featuresDict)}")) # from line 432, col 1.
        # 
    ...
    def prologueForOverriddenDimRepInFieldInBasisWithVectors(self, dimRep, field, basis, vectors, indexOverrides, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 444, col 15.
        write(''' = ''')
        _v = VFFSL(SL,"indexOverrides",True)[dimRep.name][field] # u'${indexOverrides[dimRep.name][field]}' on line 444, col 37
        if _v is not None: write(_filter(_v, rawExpr='${indexOverrides[dimRep.name][field]}')) # from line 444, col 37.
        write(''';
''')
        ...
        for vector in [v for v in vectors if v.field.dimensions == field.dimensions]: # generated from line 447, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 448, col 2.
            write('''_index_pointer += ( 0''')
            write(''' ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${explicitIndexPointerTermForVectorAndDimRepWithFieldAndBasis(vector, dimRep, field, basis, indexOverrides)}')) # from line 449, col 2.
            write(''' ) * _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 450, col 7
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 450, col 7.
            write('''_ncomponents;
''')
        write('''
''')
...
''')
        for vector in vectorsNeedingExplicitIndexPointers: # generated from line 468, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 470, col 2.
            write('''_index_pointer = ( 0''')
            for dimRep in vector.field.inBasis(basis): # generated from line 471, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${explicitIndexPointerTermForVectorAndDimRepWithFieldAndBasis(vector, dimRep, field, basis, indexOverrides)}')) # from line 472, col 1.
            write(''' ) * _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 474, col 7
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 474, col 7.
            write('''_ncomponents;
''')
        # 
...
''')
        ...
        if fieldDimRepList: # generated from line 490, col 3
            ...
            if dimRep.runtimeLattice == fieldDimRep.runtimeLattice and not hasLocalOffset: # generated from line 499, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${fieldDimRep.loopIndex}')) # from line 500, col 6.
                write(''' * ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$vector.field.localPointsInDimensionsAfterDimRepInBasis(dimRep, basis)')) # from line 501, col 4.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.localIndexFromIndexForDimensionRep(fieldDimRep)}')) # from line 503, col 8.
                write(''' )''')
                write(''' * ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$vector.field.localPointsInDimensionsAfterDimRepInBasis(dimRep, basis)')) # from line 504, col 4.
            ...
            if dimRep.name in indexOverrides: # generated from line 509, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${indexOverrides[dimRep.name][vector.field]}')) # from line 514, col 6.
                write('''  * ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$vector.field.localPointsInDimensionsAfterDimRepInBasis(dimRep, basis)')) # from line 515, col 5.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${dimRep.indexForSinglePointSample}')) # from line 525, col 8.
                write(''' )''')
                write('''  * ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$vector.field.localPointsInDimensionsAfterDimRepInBasis(dimRep, basis)')) # from line 526, col 5.
        # 
...
''')
            ...
            for componentNumber, componentName in enumerate(VFFSL(SL,"vector.components",True)): # generated from line 544, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 545, col 9.
                write('''[_''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 545, col 23
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 545, col 23.
                write('''_index_pointer + ''')
                _v = VFFSL(SL,"componentNumber",True) # u'${componentNumber}' on line 545, col 52
                if _v is not None: write(_filter(_v, rawExpr='${componentNumber}')) # from line 545, col 52.
                write('''] += ''')
                _v = VFFSL(SL,"componentName",True) # u'${componentName}' on line 545, col 75
                if _v is not None: write(_filter(_v, rawExpr='${componentName}')) # from line 545, col 75.
                ...
                for dimension in VFFSL(SL,"dimensionsIntegratedOver",True): # generated from line 547, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${dimension.inBasis(basis).name}')) # from line 548, col 5.
                write(''';
''')
        # 
    ...
    def incrementIndexPointersForVectorsWithFieldBasisAndLastLoopDimRep(self, vectors, field, basis, lastLoopDimRep, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$field.name')) # from line 566, col 50.
...
''')
        for vector in vectors: # generated from line 567, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 577, col 2.
            write('''_index_pointer += ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$field.localPointsInDimensionsAfterDimRepInBasis(lastLoopDimRep, basis)')) # from line 577, col 32.
            write(''' * _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 577, col 107
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 577, col 107.
            write('''_ncomponents;
''')
        write('''
''')
    ...
    def evaluateComputedVectors(self, vectors, static=True, **KWS):
        ...
        for vector in self.evaluationOrderForVectors(vectors, static, predicate = lambda x: x.isComputed): # generated from line 589, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr="${vector.functions['evaluate'].call()}")) # from line 590, col 1.
            write('''
''')
        # 
    ...
    def copyVectors(self, vectors, destPrefix, srcPrefix=None, **KWS):
        ...
        for vector in VFFSL(SL,"vectors",True): # generated from line 598, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 599, col 8.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 599, col 22
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 599, col 22.
            write(''', ''')
            _v = VFFSL(SL,"srcPrefix",True) # u'${srcPrefix}' on line 599, col 36
            if _v is not None: write(_filter(_v, rawExpr='${srcPrefix}')) # from line 599, col 36.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 599, col 49
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 599, col 49.
            write(''', sizeof(''')
            _v = VFFSL(SL,"vector.type",True) # u'${vector.type}' on line 599, col 70
            if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 599, col 70.
            write(''') * ''')
            _v = VFFSL(SL,"vector.allocSize",True) # u'${vector.allocSize}' on line 599, col 88
            if _v is not None: write(_filter(_v, rawExpr='${vector.allocSize}')) # from line 599, col 88.
            write(''');
''')
        # 
...
''')
        for vector in VFFSL(SL,"vectors",True): # generated from line 608, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.type}')) # from line 609, col 3.
            write('''* _temp_''')
            _v = VFFSL(SL,"destPrefix",True) # u'${destPrefix}' on line 609, col 25
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 609, col 25.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 609, col 39
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 609, col 39.
            write(''' = ''')
            _v = VFFSL(SL,"destPrefix",True) # u'${destPrefix}' on line 609, col 54
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 609, col 54.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 609, col 68
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 609, col 68.
            write(''';
  ''')
            _v = VFFSL(SL,"destPrefix",True) # u'${destPrefix}' on line 610, col 3
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 610, col 3.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 610, col 17
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 610, col 17.
            write(''' = ''')
            _v = VFFSL(SL,"srcPrefix",True) # u'${srcPrefix}' on line 610, col 32
            if _v is not None: write(_filter(_v, rawExpr='${srcPrefix}')) # from line 610, col 32.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 610, col 45
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 610, col 45.
            write(''';
  ''')
            _v = VFFSL(SL,"srcPrefix",True) # u'${srcPrefix}' on line 611, col 3
            if _v is not None: write(_filter(_v, rawExpr='${srcPrefix}')) # from line 611, col 3.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 611, col 16
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 611, col 16.
            write(''' = _temp_''')
            _v = VFFSL(SL,"destPrefix",True) # u'${destPrefix}' on line 611, col 37
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 611, col 37.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 611, col 51
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 611, col 51.
            write(''';
''')
        write('''}
''')
    ...
    def assignVectorPointers(self, vectors, destPrefix, srcPrefix=None, **KWS):
        ...
        for vector in VFFSL(SL,"vectors",True): # generated from line 620, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${destPrefix}')) # from line 621, col 1.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 621, col 15
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 621, col 15.
            write(''' = ''')
            _v = VFFSL(SL,"srcPrefix",True) # u'${srcPrefix}' on line 621, col 30
            if _v is not None: write(_filter(_v, rawExpr='${srcPrefix}')) # from line 621, col 30.
            write('''_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 621, col 43
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 621, col 43.
            write(''';
''')
        # 
