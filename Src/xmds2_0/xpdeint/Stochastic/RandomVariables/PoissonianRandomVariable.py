...
const real _new_var = 1.0 / (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.spatiallyIndependentVolumeElement}')) # from line 36, col 30.
        write(''' * _new_step);
const real _old_volume = (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.spatiallyIndependentVolumeElement}')) # from line 37, col 27.
        write(''' * _old_step);
...
''')
        ...
        for componentNumber, component in enumerate(noiseVector.components): # generated from line 49, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${component}')) # from line 50, col 1.
            write(''' = _new_var''')
            _v = VFFSL(SL,"varFixup",True) # u'${varFixup}' on line 50, col 24
            if _v is not None: write(_filter(_v, rawExpr='${varFixup}')) # from line 50, col 24.
            write(''' * _poisplit_''')
            _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 50, col 48
            if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 50, col 48.
            write('''(_new_step/_old_step, lrint(_old_array[_''')
            _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 50, col 105
            if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 50, col 105.
            write('''_index_pointer + ''')
            _v = VFFSL(SL,"componentNumber",True) # u'${componentNumber}' on line 50, col 139
            if _v is not None: write(_filter(_v, rawExpr='${componentNumber}')) # from line 50, col 139.
            write('''] * _old_volume''')
            _v = VFFSL(SL,"volumeFixup",True) # u'${volumeFixup}' on line 50, col 172
            if _v is not None: write(_filter(_v, rawExpr='${volumeFixup}')) # from line 50, col 172.
            write('''));
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${loopOverFieldInBasisWithVectorsAndInnerContent(noiseVector.field, noiseVector.initialBasis, [noiseVector], loopString)}')) # from line 53, col 1.
        write('''
''')
        # 
    ...
    def makeNoises(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.spatiallyIndependentVolumeElement}')) # from line 68, col 20.
...
''')
        ...
        for component in noiseVector.components: # generated from line 84, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${component}')) # from line 85, col 1.
            write(''' = _var''')
            _v = VFFSL(SL,"varFixup",True) # u'${varFixup}' on line 85, col 20
            if _v is not None: write(_filter(_v, rawExpr='${varFixup}')) # from line 85, col 20.
            write(''' * _poidev_''')
            _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 85, col 42
            if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 85, col 42.
            write('''(''')
            _v = VFFSL(SL,"noiseMeanRate",True) # u'${noiseMeanRate}' on line 85, col 60
            if _v is not None: write(_filter(_v, rawExpr='${noiseMeanRate}')) # from line 85, col 60.
            write(''' * _dVdt''')
            _v = VFFSL(SL,"volumeFixup",True) # u'${volumeFixup}' on line 85, col 84
            if _v is not None: write(_filter(_v, rawExpr='${volumeFixup}')) # from line 85, col 84.
            write(''');
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${loopOverFieldInBasisWithVectorsAndInnerContent(noiseVector.field, noiseVector.initialBasis, [noiseVector], loopString)}')) # from line 88, col 1.
        # 
    ...
    def functionPrototypes(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 98, col 14.
        write('''(real xm);
real _poisplit_''')
        _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 99, col 16
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 99, col 16.
        write('''(real pp, int n);
''')
        # 
    ...
    def functionImplementations(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 109, col 14.
        write('''(real xm)
{
  ...
  if (xm < 12.0) {        // Use direct method
    ...
    do {
      ...
      t *= ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 122, col 12.
        write(''';
    } while (t > g);
  } else {
    ...
    do {
      do {
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 132, col 22.
        write(''');
      ...
      // deviate. The factor 0.9 so that t never exceeds 1.
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 141, col 14.
        write(''' > t);
  }
  return em;
}
...
real _poisplit_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 146, col 16.
        write('''(real pp, int n)
{
  /*
  ...
  if (n < 25) {
    ...
    for (j = 1; j <= n; j++)
      if (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 169, col 11.
        write(''' < p)
        ++bnl;
  } else if (am < 1.0) {
    ...
    for (j = 0; j <= n; j++) {
      t *= ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 176, col 12.
        write(''';
      if (t < g)
        break;
    }
    ...
    do {
      do {
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 191, col 22.
        write(''');
        em = sq*y + am;
      ...
      t = 1.2 * sq * (1.0 + y*y) * exp(oldg - lgamma(em + 1.0) - lgamma(en - em + 1.0) + em*plog + (en - em)*pclog); 
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.zeroToOneRandomNumber()}')) # from line 196, col 14.
