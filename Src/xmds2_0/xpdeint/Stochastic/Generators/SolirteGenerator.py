...
class SolirteGenerator(Generator):
    ...
    def globals(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$generatorType')) # from line 34, col 1.
        write(''' ''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 34, col 16
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 34, col 16.
        write(''';
''')
        # 
...
""")
    ...
    def initialiseLocalSeeds(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 73, col 1.
        write(''' = new CPRNG<CSFMTParams_19937>(''')
        _v = VFFSL(SL,"seedString",True) # u'$seedString' on line 73, col 49
        if _v is not None: write(_filter(_v, rawExpr='$seedString')) # from line 73, col 49.
        write(''');
''')
        # 
