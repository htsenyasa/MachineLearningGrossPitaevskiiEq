...
''')
    ...
    def constructArrayUniformRandomNumbers(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 45, col 39.
        write(''', _vector_size, reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 45, col 103
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 45, col 103.
        write('''), 0.0, 1.0);
''')
...
''')
    ...
    def initialiseLocalSeeds(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 66, col 15.
        write(''', VSL_BRNG_MT19937, ''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 66, col 51
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 66, col 51.
