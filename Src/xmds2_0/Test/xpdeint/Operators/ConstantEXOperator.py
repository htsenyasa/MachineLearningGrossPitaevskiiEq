...
class ConstantEXOperator(_EXOperator):
    ...
    def description(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$field.name')) # from line 26, col 63.
    ...
    def insideCalculateOperatorFieldLoops(self, codeString, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${insideCalculateOperatorFieldLoopsBegin}')) # from line 32, col 1.
        # 
        write('''// ************** Operator code *****************
''')
...
''')
    ...
    def evaluateOperatorFunctionContentsWithoutCodeBlock(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${optimisedOperatorCopyBegin}')) # from line 42, col 1.
        # 
        ...
        if _v is not None: write(_filter(_v, rawExpr='${optimisedOperatorCopyEnd}')) # from line 46, col 1.
        # 
    ...
    def evaluateOperatorLoop(self, setOfVectorsToLoopOver, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${loopOverVectorsInBasisWithInnerContent(setOfVectorsToLoopOver, $operatorBasis, $insideEvaluateOperatorLoops)}')) # from line 52, col 1.
        # 
    ...
    def insideEvaluateOperatorLoops(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${insideEvaluateOperatorLoopsBegin}')) # from line 58, col 1.
        # 
        for operatorComponentNumber, (operatorComponentName, operatorComponentVectors) in enumerate(VFN(VFFSL(SL,"operatorComponents",True),"iteritems",False)()): # generated from line 60, col 3
            for targetVectorComponents in operatorComponentVectors.values(): # generated from line 61, col 5
                for targetVectorComponent in targetVectorComponents: # generated from line 62, col 7
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${operatorComponentName}')) # from line 63, col 4.
                    write('''[''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'$targetVectorComponent' on line 63, col 29
                    if _v is not None: write(_filter(_v, rawExpr='$targetVectorComponent')) # from line 63, col 29.
                    write(''']
_''')
                    _v = VFFSL(SL,"operatorComponentName",True) # u'${operatorComponentName}' on line 64, col 2
                    if _v is not None: write(_filter(_v, rawExpr='${operatorComponentName}')) # from line 64, col 2.
                    write('''_''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'${targetVectorComponent}' on line 64, col 27
                    if _v is not None: write(_filter(_v, rawExpr='${targetVectorComponent}')) # from line 64, col 27.
                    write(''' = ''')
                    _v = VFFSL(SL,"operatorComponentName",True) # u'$operatorComponentName' on line 64, col 54
                    if _v is not None: write(_filter(_v, rawExpr='$operatorComponentName')) # from line 64, col 54.
                    write(''' * ''')
                    _v = VFFSL(SL,"targetVectorComponent",True) # u'$targetVectorComponent' on line 64, col 79
                    if _v is not None: write(_filter(_v, rawExpr='$targetVectorComponent')) # from line 64, col 79.
                    write(''';
''')
        # 
