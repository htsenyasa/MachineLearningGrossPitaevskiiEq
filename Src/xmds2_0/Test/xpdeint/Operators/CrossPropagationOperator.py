...
class CrossPropagationOperator(_CrossPropagationOperator):
    ...
    def description(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$field.name')) # from line 24, col 52.
        write(""" in dimension '""")
        _v = VFFSL(SL,"propagationDirection",True) # u'${propagationDirection}' on line 24, col 78
        if _v is not None: write(_filter(_v, rawExpr='${propagationDirection}')) # from line 24, col 78.
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 24, col 101
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 24, col 101.
        write("""'""")
    ...
    def evaluateOperatorFunctionContents(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${crossPropagationIntegrator.functions['segment'].call(parentFunction=function)}")) # from line 28, col 1.
        write('''
''')
        # 
