...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${evaluateComputedVectors($dynamicVectorsNeedingPrecalculationForOperatorContainers($operatorContainers))}')) # from line 37, col 1.
            # 
...
''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${operatorContainer.evaluateOperators(parentFunction = function)}')) # from line 41, col 1.
            # 
