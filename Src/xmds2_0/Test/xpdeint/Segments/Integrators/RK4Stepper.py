...
class RK4Stepper(_Stepper):
    ...
    def singleIntegrationStep(self, function, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 39, col 1.
        write('''
// a_k = a
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${copyVectors($integrationVectors, '_akfield')}")) # from line 42, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('nonconstantIPFields', arguments, _exponent = 1, parentFunction = function)}")) # from line 44, col 1.
        write('''
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function)}")) # from line 47, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 48, col 1.
        write('''
// a_i = a
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${copyVectors($integrationVectors, '_aifield')}")) # from line 51, col 1.
        write('''
''')
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 53, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 54, col 9.
            write(''' = _akfield_''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 54, col 33
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 54, col 33.
            write(''';
''')
        write('''  
// a_k = G[a_k, t]
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('deltaA', arguments, parentFunction = function)}")) # from line 58, col 1.
        write('''
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function)}")) # from line 61, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 62, col 1.
        write('''
''')
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 71, col 1.
        write(''' += 0.5*_step;
''')
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${interpolateDependencies}')) # from line 74, col 1.
        write('''
// a_k = G[a_k, t + h/2]
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('deltaA', arguments, parentFunction = function)}")) # from line 78, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 79, col 1.
        write('''
''')
        _v = VFFSL(SL,"loopOverVectorsWithInnerContentTemplate",False)(VFFSL(SL,"integrationVectors",True),
"""// a = a + a_k/3
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('deltaA', arguments, parentFunction = function)}")) # from line 89, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 90, col 1.
        write('''
''')
        _v = VFFSL(SL,"loopOverVectorsWithInnerContentTemplate",False)(VFFSL(SL,"integrationVectors",True),
"""// a = a + a_k/3
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function)}")) # from line 100, col 1.
        write('''

''')
        _v = VFFSL(SL,"propagationDimension",True) # u'${propagationDimension}' on line 102, col 1
        if _v is not None: write(_filter(_v, rawExpr='${propagationDimension}')) # from line 102, col 1.
        write(''' += 0.5*_step;
''')
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${updateDependenciesForNextStep}')) # from line 105, col 1.
        write('''
// a_k = G[a_k, t + h]
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('deltaA', arguments, parentFunction = function)}")) # from line 109, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 110, col 1.
        write('''
''')
        for vector in VFFSL(SL,"integrationVectors",True): # generated from line 112, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 113, col 9.
            write(''' = _''')
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${callFunction('ipEvolve', arguments, _exponent = +1, parentFunction = function)}")) # from line 117, col 1.
        write('''
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${transformVectorsToBasis($integrationVectors, $homeBasis)}')) # from line 118, col 1.
        write('''
''')
        _v = VFFSL(SL,"loopOverVectorsWithInnerContentTemplate",False)(VFFSL(SL,"integrationVectors",True), 
"""// a = a + a_k/6
...
""")
        ...
        if _v is not None: write(_filter(_v, rawExpr='${integrator.stepCount}')) # from line 143, col 23.
        write(''' - 1)) {
