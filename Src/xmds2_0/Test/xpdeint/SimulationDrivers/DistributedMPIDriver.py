...
class DistributedMPIDriver(_DistributedMPIDriver):
    ...
    def preAllocation(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${distributedTransform.setLocalLatticeAndOffsetVariables, autoIndent=True}')) # from line 28, col 3.
        # 
        ...
        write('''int main(int argc, char **argv)
{
  ...
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${mainRoutineInnerContent, autoIndent=True}')) # from line 40, col 3.
        write('''  
  MPI_Finalize();
...
''')
    ...
    def setVectorAllocSizes(self, vectors, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${distributedTransform.setVectorAllocSizes(vectors)}')) # from line 53, col 1.
        # 
    ...
    def loopOverFieldInBasisWithVectorsAndInnerContentEnd(self, dict, **KWS):
        ...
        for vector in VFFSL(SL,"vectorOverrides",True): # generated from line 64, col 3
            ...
            for dimRepName in indexOverrides.keys(): # generated from line 74, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='$arrayName')) # from line 87, col 29.
            write(''', ''')
            _v = VFFSL(SL,"size",True) # u'$size' on line 87, col 41
            if _v is not None: write(_filter(_v, rawExpr='$size')) # from line 87, col 41.
            write(''',
...
''')
    ...
    def findMax(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$variable')) # from line 99, col 29.
        write(''', ''')
        _v = VFFSL(SL,"count",True) # u'$count' on line 99, col 40
        if _v is not None: write(_filter(_v, rawExpr='$count')) # from line 99, col 40.
        write(''', MPI_''')
        _v = VFFSL(SL,"type",True) # u'${type}' on line 99, col 52
        if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 99, col 52.
        write(''', MPI_''')
        _v = VFFSL(SL,"op",True) # u'${op}' on line 99, col 65
        if _v is not None: write(_filter(_v, rawExpr='${op}')) # from line 99, col 65.
...
""")
        for shadowVariable in VFFSL(SL,"shadowedVariablesForField",False)(field): # generated from line 130, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$shadowVariable')) # from line 131, col 18.
            write(''';
...
''')
        ...
        for variable in VFFSL(SL,"dependentVariables",True): # generated from line 136, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.vector.sizeInBasisInReals(basis)}')) # from line 137, col 18.
            write(''';
  MPI_Ssend(&_sending_var, sizeof(ptrdiff_t), MPI_BYTE, 0, 0, MPI_COMM_WORLD);
  if (_sending_var == 0)
  ...
  MPI_Ssend(''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 141, col 13.
            write(''', ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.vector.sizeInBasisInReals(basis)}')) # from line 141, col 36.
...
''')
    ...
    def binaryWriteOutWriteDataBegin(self, dict, **KWS):
        ...
        for shadowVariable in VFFSL(SL,"shadowedVariablesForField",False)(field): # generated from line 161, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 162, col 14.
            write(''' = ''')
            _v = VFFSL(SL,"shadowVariable",True) # u'${shadowVariable}' on line 162, col 34
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 162, col 34.
            write(''';
''')
        # 
        write('''
''')
        for variable in VFFSL(SL,"dependentVariables",True): # generated from line 166, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.vector.type}')) # from line 167, col 1.
            write('''* _local''')
            _v = VFFSL(SL,"variable.arrayName",True) # u'${variable.arrayName}' on line 167, col 32
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 167, col 32.
            write(''';
''')
            _v = VFFSL(SL,"variable.vector.type",True) # u'${variable.vector.type}' on line 168, col 1
            if _v is not None: write(_filter(_v, rawExpr='${variable.vector.type}')) # from line 168, col 1.
            write('''* _backup''')
            _v = VFFSL(SL,"variable.arrayName",True) # u'${variable.arrayName}' on line 168, col 33
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 168, col 33.
            write(''' = ''')
            _v = VFFSL(SL,"variable.arrayName",True) # u'${variable.arrayName}' on line 168, col 57
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 168, col 57.
            write(''';
''')
        write('''
...
''')
        for shadowVariable in VFFSL(SL,"shadowedVariablesForField",False)(field): # generated from line 172, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 173, col 13.
            write(''';
''')
...
''')
        for shadowVariable in VFFSL(SL,"shadowedVariablesForField",False)(field): # generated from line 178, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 179, col 5.
            write(''' = _my''')
            _v = VFFSL(SL,"shadowVariable",True) # u'${shadowVariable}' on line 179, col 28
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 179, col 28.
            write(''';
''')
        write('''    
  } else {
...
''')
        for shadowVariable in VFFSL(SL,"shadowedVariablesForField",False)(field): # generated from line 184, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${shadowVariable}')) # from line 185, col 15.
...
''')
    ...
    _local''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 194, col 11.
            write(''' = (''')
            _v = VFFSL(SL,"variable.vector.type",True) # u'${variable.vector.type}' on line 194, col 36
            if _v is not None: write(_filter(_v, rawExpr='${variable.vector.type}')) # from line 194, col 36.
    ...
    MPI_Recv(_local''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 195, col 20.
    ...
    ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 197, col 5.
            write(''' = _local''')
            _v = VFFSL(SL,"variable.arrayName",True) # u'${variable.arrayName}' on line 197, col 35
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 197, col 35.
            write(''';
...
''')
        for variable in VFFSL(SL,"dependentVariables",True): # generated from line 218, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 219, col 21.
            write(''');
''')
        write('''  }
...
''')
        for variable in VFFSL(SL,"dependentVariables",True): # generated from line 223, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 224, col 1.
            write(''' = _backup''')
            _v = VFFSL(SL,"variable.arrayName",True) # u'${variable.arrayName}' on line 224, col 32
            if _v is not None: write(_filter(_v, rawExpr='${variable.arrayName}')) # from line 224, col 32.
            write(''';
''')
        write('''
''')
    ...
    def writeDataHDF5ModifyLoopContents(self, dict, **KWS):
        ...
        for fileDimIndex, memDimIndex, dimRep in dimRepOrdering: # generated from line 243, col 5
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 244, col 20.
            write(''' = file_start[''')
            _v = VFFSL(SL,"fileDimIndex",True) # u'$fileDimIndex' on line 244, col 48
            if _v is not None: write(_filter(_v, rawExpr='$fileDimIndex')) # from line 244, col 48.
            write('''];
hsize_t mem_start_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 245, col 19
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 245, col 19.
            write(''' = mem_start[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 245, col 46
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 245, col 46.
            write('''];
hsize_t count_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 246, col 15
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 246, col 15.
            write(''' = mem_count[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 246, col 42
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 246, col 42.
            write('''];
mem_count[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 247, col 11
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 247, col 11.
            write('''] = 1;
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${hdf5DataCopyLoops(dimRepOrdering[:], writeLoopContents)}')) # from line 251, col 1.
...
file_start[''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$fileDimIndex')) # from line 254, col 12.
            write('''] = file_start_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 254, col 40
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 254, col 40.
            write(''';
mem_start[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 255, col 11
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 255, col 11.
            write('''] = mem_start_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 255, col 37
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 255, col 37.
            write(''';
mem_count[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 256, col 11
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 256, col 11.
            write('''] = count_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 256, col 33
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 256, col 33.
            write(''';
''')
    ...
    def hdf5DataCopyLoops(self, remainingDimReps, writeLoopContents, **KWS):
        ...
        if not remainingDimReps: # generated from line 265, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${writeLoopContents}')) # from line 266, col 1.
            ...
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 269, col 16.
            write(''' = 0; _i''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 269, col 38
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 269, col 38.
            write(''' < count_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 269, col 61
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 269, col 61.
            write('''; _i''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 269, col 79
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 269, col 79.
            write('''++) {
  file_start[''')
            _v = VFFSL(SL,"fileDimIndex",True) # u'$fileDimIndex' on line 270, col 14
            if _v is not None: write(_filter(_v, rawExpr='$fileDimIndex')) # from line 270, col 14.
            write('''] = file_start_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 270, col 42
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 270, col 42.
            write(''' + _i''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 270, col 61
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 270, col 61.
            write(''';
  mem_start[''')
            _v = VFFSL(SL,"memDimIndex",True) # u'$memDimIndex' on line 271, col 13
            if _v is not None: write(_filter(_v, rawExpr='$memDimIndex')) # from line 271, col 13.
            write('''] = mem_start_''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 271, col 39
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 271, col 39.
            write(''' + _i''')
            _v = VFFSL(SL,"dimRep.name",True) # u'${dimRep.name}' on line 271, col 58
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.name}')) # from line 271, col 58.
            write(''';
  ...
  ''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${hdf5DataCopyLoops(remainingDimReps, writeLoopContents), autoIndent=True}')) # from line 273, col 3.
            write('''}
''')
...
MPI_Bcast(_active_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 311, col 19.
        write(''', ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.sizeInBasisInReals(noiseVector.initialBasis)}')) # from line 311, col 38.
...
unsigned long _local_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 322, col 22.
        write('''_seeds[''')
        _v = VFFSL(SL,"generator.seedCount",True) # u'${generator.seedCount}' on line 322, col 55
        if _v is not None: write(_filter(_v, rawExpr='${generator.seedCount}')) # from line 322, col 55.
        write('''];
if (_rank == 0) {
''')
        dict['extraIndent'] += 2
    ...
    def runtimeSeedGenerationEnd(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.seedCount}')) # from line 332, col 27.
        write('''; _i0++)
      _local_''')
        _v = VFFSL(SL,"generator.generatorName",True) # u'${generator.generatorName}' on line 333, col 14
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 333, col 14.
        write('''_seeds[_i0] = (unsigned long)''')
        _v = VFFSL(SL,"generator.generatorName",True) # u'${generator.generatorName}' on line 333, col 69
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 333, col 69.
        write('''_seeds[_i0];
}
// Broadcast seeds to other nodes
MPI_Bcast(_local_''')
        _v = VFFSL(SL,"generator.generatorName",True) # u'${generator.generatorName}' on line 336, col 18
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 336, col 18.
        write('''_seeds, ''')
        _v = VFFSL(SL,"generator.seedCount",True) # u'${generator.seedCount}' on line 336, col 52
        if _v is not None: write(_filter(_v, rawExpr='${generator.seedCount}')) # from line 336, col 52.
...
for (int _i0 = 0; _i0 < ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.seedCount}')) # from line 338, col 25.
        write('''; _i0++)
    ''')
        _v = VFFSL(SL,"generator.generatorName",True) # u'${generator.generatorName}' on line 339, col 5
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 339, col 5.
        write('''_seeds[_i0] = (uint32_t)_local_''')
        _v = VFFSL(SL,"generator.generatorName",True) # u'${generator.generatorName}' on line 339, col 62
        if _v is not None: write(_filter(_v, rawExpr='${generator.generatorName}')) # from line 339, col 62.
        write('''_seeds[_i0];
