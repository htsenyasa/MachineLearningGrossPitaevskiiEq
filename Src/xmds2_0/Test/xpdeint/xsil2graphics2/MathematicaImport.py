...
class MathematicaImport(Template):
    ...
    def printMathematicaListOrElement(self, listOrElement, **KWS):
        ...
        if isinstance(listOrElement,float): # generated from line 31, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr="${format(float(listOrElement),'f')}")) # from line 32, col 1.
            ...
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([$printMathematicaListOrElement(element) for element in listOrElement])}")) # from line 34, col 2.
            write('''}''')
        ...
        for objectNum, xsilObject in enumerate(xsilFile.xsilObjects): # generated from line 42, col 2
            if xsilObject.data.format == 'ascii': # generated from line 43, col 4
                ...
                for var in xsilObject.independentVariables: # generated from line 45, col 6
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 48, col 7.
                    write(''']
''')
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${\', \'.join([format(float(e),\'f\') for e in var["array"]])}')) # from line 49, col 13.
                    write('''};
''')
                for varD in xsilObject.dependentVariables: # generated from line 51, col 6
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 54, col 7.
                    write(''']
''')
                    _v = VFFSL(SL,"varName",True) # u'$varName' on line 55, col 1
                    if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 55, col 1.
                    write(''' = ''')
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$printMathematicaListOrElement($varD["array"])')) # from line 55, col 12.
                    write(''';      
''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$xsilObject.data.filename')) # from line 63, col 19.
...
''')
                for var in xsilObject.independentVariables: # generated from line 64, col 6
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 67, col 1.
                    write('''Len = BinaryRead[fpDat, "''')
                    _v = VFFSL(SL,"uLongFormat",True) # u'$uLongFormat' on line 67, col 36
                    if _v is not None: write(_filter(_v, rawExpr='$uLongFormat')) # from line 67, col 36.
                    write('''", ByteOrdering->''')
                    _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 67, col 65
                    if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 67, col 65.
                    write('''];
''')
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$outputPrecision')) # from line 68, col 46.
                    write('''"}, ''')
                    _v = VFFSL(SL,"varName",True) # u'$(varName)' on line 68, col 66
                    if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 68, col 66.
                    write('''Len, ByteOrdering->''')
                    _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 68, col 95
                    if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 68, col 95.
                    write(''']];
''')
                for varD in xsilObject.dependentVariables: # generated from line 70, col 6
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 73, col 1.
                    write('''Len = BinaryRead[fpDat, "''')
                    _v = VFFSL(SL,"uLongFormat",True) # u'$uLongFormat' on line 73, col 36
                    if _v is not None: write(_filter(_v, rawExpr='$uLongFormat')) # from line 73, col 36.
                    write('''", ByteOrdering->''')
                    _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 73, col 65
                    if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 73, col 65.
                    write('''];
''')
                    if nIndepVar<=1: # generated from line 74, col 9
                        ...
                        if _v is not None: write(_filter(_v, rawExpr='$outputPrecision')) # from line 75, col 44.
                        write('''"}, ''')
                        _v = VFFSL(SL,"varName",True) # u'$(varName)' on line 75, col 64
                        if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 75, col 64.
                        write('''Len, ByteOrdering->''')
                        _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 75, col 93
                        if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 75, col 93.
                        write(''']];
''')
                        ...
                        if _v is not None: write(_filter(_v, rawExpr='$outputPrecision')) # from line 77, col 50.
                        write('''"}, ''')
                        ...
                        if _v is not None: write(_filter(_v, rawExpr='$(xsilObject.independentVariables[-1]["name"])')) # from line 77, col 70.
                        _v = VFFSL(SL,"objectNum",True)+1 # u'$(objectNum+1)' on line 77, col 116
                        if _v is not None: write(_filter(_v, rawExpr='$(objectNum+1)')) # from line 77, col 116.
                        write('''Len, ByteOrdering->''')
                        _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 77, col 149
                        if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 77, col 149.
                        write(''']''')
                        for varIndex, varI in enumerate(xsilObject.independentVariables[0:-1]): # generated from line 78, col 11
                            ...
                            if _v is not None: write(_filter(_v, rawExpr='$(varIndex+1)')) # from line 79, col 4.
                            write(''',1,''')
                            _v = VFN(VFFSL(SL,"varI",True)["name"],"replace",False)('_','') # u'$(varI["name"].replace(\'_\',\'\'))' on line 79, col 20
                            if _v is not None: write(_filter(_v, rawExpr='$(varI["name"].replace(\'_\',\'\'))')) # from line 79, col 20.
                            _v = VFFSL(SL,"objectNum",True)+1 # u'$(objectNum+1)' on line 79, col 51
                            if _v is not None: write(_filter(_v, rawExpr='$(objectNum+1)')) # from line 79, col 51.
                            write('''Len}''')
                        write('''],{''')
                        for varIndex, varI2 in enumerate(xsilObject.independentVariables[0:-1]): # generated from line 82, col 11
                            ...
                            if _v is not None: write(_filter(_v, rawExpr='$(varIndex+1)')) # from line 83, col 2.
                            write('''},''')
                        write('''{''')
                        _v = VFFSL(SL,"nIndepVar",True) # u'$nIndepVar' on line 85, col 2
                        if _v is not None: write(_filter(_v, rawExpr='$nIndepVar')) # from line 85, col 2.
                        write(''',''')
                        _v = VFFSL(SL,"nIndepVar",True)+1 # u'$(nIndepVar+1)' on line 85, col 13
                        if _v is not None: write(_filter(_v, rawExpr='$(nIndepVar+1)')) # from line 85, col 13.
                        write('''}}];
''')
                write('''Close[fpDat];
''')
                ...
                for var in variables: # generated from line 94, col 6
                    ...
                    if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 97, col 22.
                    write('''", {"Datasets", "''')
                    _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 97, col 50
                    if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 97, col 50.
                    write('''/''')
                    _v = VFFSL(SL,"var.name",True) # u'${var.name}' on line 97, col 63
                    if _v is not None: write(_filter(_v, rawExpr='${var.name}')) # from line 97, col 63.
                    write('''"}];
''')
...
declaredVariables={''')
        _v = ', '.join([''.join(['"',str(VFFSL(SL,"dV",True)),'"']) for dV in declaredVars]) # u'${\', \'.join([c\'"$dV"\' for dV in declaredVars])}' on line 105, col 20
        if _v is not None: write(_filter(_v, rawExpr='${\', \'.join([c\'"$dV"\' for dV in declaredVars])}')) # from line 105, col 20.
        write('''}
''')
