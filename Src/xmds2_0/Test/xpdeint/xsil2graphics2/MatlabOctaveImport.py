...
class MatlabOctaveImport(Template):
    ...
    def printMatlabListOrElement(self, listOrElement, currentDepth, **KWS):
        ...
        if isinstance(listOrElement,float): # generated from line 32, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${format(float(listOrElement),$stringFormat)}')) # from line 33, col 1.
        else: # generated from line 34, col 3
            write('''cat(''')
            _v = VFFSL(SL,"currentDepth",True) # u'$currentDepth' on line 35, col 5
            if _v is not None: write(_filter(_v, rawExpr='$currentDepth')) # from line 35, col 5.
            write(''', ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${', '.join([$printMatlabListOrElement(element, currentDepth - 1) for element in listOrElement])}")) # from line 35, col 20.
            write(''')''')
    ...
    def permuteDimensionsOfMATLABVariable(self, varName, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${varName}')) # from line 40, col 1.
        write(''' = permute(''')
        _v = VFFSL(SL,"varName",True) # u'${varName}' on line 40, col 22
        if _v is not None: write(_filter(_v, rawExpr='${varName}')) # from line 40, col 22.
        write(''', ndims(''')
        _v = VFFSL(SL,"varName",True) # u'${varName}' on line 40, col 40
        if _v is not None: write(_filter(_v, rawExpr='${varName}')) # from line 40, col 40.
        write('''):-1:1);
''')
    ...
    def loadXSILFile(self, xsilFile, **KWS):
        ...
        for objectNum, xsilObject in enumerate(xsilFile.xsilObjects): # generated from line 48, col 3
            if xsilObject.data.format == 'ascii': # generated from line 49, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${handleASCIIXSILObject(objectNum, xsilObject)}')) # from line 50, col 1.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${handleBinaryXSILObject(objectNum, xsilObject)}')) # from line 52, col 1.
                ...
                if _v is not None: write(_filter(_v, rawExpr='${handleHDF5XSILObject(objectNum, xsilObject)}')) # from line 54, col 1.
    ...
    def handleASCIIXSILObject(self, objectNum, xsilObject, **KWS):
        ...
        for var in xsilObject.independentVariables: # generated from line 63, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 65, col 7.
            write('''
''')
            _v = VFFSL(SL,"varName",True) # u'$varName' on line 66, col 1
            if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 66, col 1.
            write(''' = [''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${\', \'.join([format(float(e),$stringFormat) for e in var["array"]])}')) # from line 66, col 13.
            write('''];
''')
        for var in xsilObject.dependentVariables: # generated from line 68, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 70, col 7.
            write('''
''')
            if nIndepVar == 1: # generated from line 71, col 5
                _v = VFFSL(SL,"varName",True) # u'$varName' on line 72, col 1
                if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 72, col 1.
                write(''' = [''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${\', \'.join([format(float(e), $stringFormat) for e in var["array"]])}')) # from line 72, col 13.
                write('''];
''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${\';\'.join([(\',\'.join([format(float(val), $stringFormat) for val in subArray])) for subArray in var["array"]])}')) # from line 74, col 13.
                write('''];
''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$printMatlabListOrElement($var["array"], $nIndepVar)')) # from line 76, col 12.
                write(''';
''')
            _v = VFFSL(SL,"permuteDimensionsOfMATLABVariable",False)(varName) # u'${permuteDimensionsOfMATLABVariable(varName)}' on line 78, col 1
            if _v is not None: write(_filter(_v, rawExpr='${permuteDimensionsOfMATLABVariable(varName)}')) # from line 78, col 1.
    ...
    def handleBinaryXSILObject(self, objectNum, xsilObject, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$xsilObject.data.filename')) # from line 88, col 16.
        write("""','r', '""")
        _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 88, col 49
        if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 88, col 49.
        write("""');
if (fpDat < 0)
  disp('Cannot open binary data file: """)
        _v = VFFSL(SL,"xsilObject.data.filename",True) # u'${xsilObject.data.filename}' on line 90, col 39
        if _v is not None: write(_filter(_v, rawExpr='${xsilObject.data.filename}')) # from line 90, col 39.
        write("""');
  return;
end
xmds_variableShape = [];
""")
        for var in xsilObject.independentVariables: # generated from line 94, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 97, col 1.
            write("""Len = fread(fpDat, 1, '""")
            _v = VFFSL(SL,"uLongFormat",True) # u'$uLongFormat' on line 97, col 34
            if _v is not None: write(_filter(_v, rawExpr='$uLongFormat')) # from line 97, col 34.
            write("""');
""")
            _v = VFFSL(SL,"varName",True) # u'$(varName)' on line 98, col 1
            if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 98, col 1.
            write(''' = fread(fpDat, ''')
            _v = VFFSL(SL,"varName",True) # u'$(varName)' on line 98, col 27
            if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 98, col 27.
            write("""Len, '""")
            _v = VFFSL(SL,"outputPrecision",True) # u'$outputPrecision' on line 98, col 43
            if _v is not None: write(_filter(_v, rawExpr='$outputPrecision')) # from line 98, col 43.
            write("""');
xmds_variableShape = [""")
            _v = VFFSL(SL,"varName",True) # u'${varName}' on line 99, col 23
            if _v is not None: write(_filter(_v, rawExpr='${varName}')) # from line 99, col 23.
...
''')
        for varD in xsilObject.dependentVariables: # generated from line 106, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 109, col 1.
            write("""Len = fread(fpDat, 1, '""")
            _v = VFFSL(SL,"uLongFormat",True) # u'$uLongFormat' on line 109, col 34
            if _v is not None: write(_filter(_v, rawExpr='$uLongFormat')) # from line 109, col 34.
            write("""', 0, '""")
            _v = VFFSL(SL,"machineFormat",True) # u'$machineFormat' on line 109, col 53
            if _v is not None: write(_filter(_v, rawExpr='$machineFormat')) # from line 109, col 53.
            write("""');
""")
            _v = VFFSL(SL,"varName",True) # u'$varName' on line 110, col 1
            if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 110, col 1.
            write(''' = fread(fpDat, ''')
            _v = VFFSL(SL,"varName",True) # u'$(varName)' on line 110, col 25
            if _v is not None: write(_filter(_v, rawExpr='$(varName)')) # from line 110, col 25.
            write("""Len, '""")
            _v = VFFSL(SL,"outputPrecision",True) # u'$outputPrecision' on line 110, col 41
            if _v is not None: write(_filter(_v, rawExpr='$outputPrecision')) # from line 110, col 41.
            write("""');
""")
            ...
            if _v is not None: write(_filter(_v, rawExpr='$varName')) # from line 111, col 20.
...
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${permuteDimensionsOfMATLABVariable(varName)}')) # from line 112, col 1.
        write('''fclose(fpDat);
clear ''')
        _v = ' '.join(variablesToClear) # u"${' '.join(variablesToClear)}" on line 115, col 7
        if _v is not None: write(_filter(_v, rawExpr="${' '.join(variablesToClear)}")) # from line 115, col 7.
        write('''
''')
  ...
  """)
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${handleHDF5XSILObjectForOctave(objectNum, xsilObject), autoIndent=True}')) # from line 120, col 3.
        write('''else % MATLAB
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${handleHDF5XSILObjectForMATLAB(objectNum, xsilObject), autoIndent=True}')) # from line 122, col 3.
        write('''end
''')
    ...
    def handleHDF5XSILObjectForMATLAB(self, objectNum, xsilObject, **KWS):
        ...
        for var in xsilObject.independentVariables: # generated from line 130, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${outName}')) # from line 132, col 1.
            write(""" = hdf5read('""")
            _v = VFFSL(SL,"filename",True) # u'${filename}' on line 132, col 24
            if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 132, col 24.
            write("""', '""")
            _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 132, col 39
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 132, col 39.
            write('''/''')
            _v = VFFSL(SL,"var.name",True) # u'${var.name}' on line 132, col 52
            if _v is not None: write(_filter(_v, rawExpr='${var.name}')) # from line 132, col 52.
            write("""');
""")
        for var in xsilObject.dependentVariables: # generated from line 134, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${outName}')) # from line 136, col 1.
            write(""" = hdf5read('""")
            _v = VFFSL(SL,"filename",True) # u'${filename}' on line 136, col 24
            if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 136, col 24.
            write("""', '""")
            _v = VFFSL(SL,"groupName",True) # u'${groupName}' on line 136, col 39
            if _v is not None: write(_filter(_v, rawExpr='${groupName}')) # from line 136, col 39.
            write('''/''')
            _v = VFFSL(SL,"var.name",True) # u'${var.name}' on line 136, col 52
            if _v is not None: write(_filter(_v, rawExpr='${var.name}')) # from line 136, col 52.
            write("""');
""")
            ...
            if _v is not None: write(_filter(_v, rawExpr='${permuteDimensionsOfMATLABVariable(outName)}')) # from line 137, col 1.
    ...
    def handleHDF5XSILObjectForOctave(self, objectNum, xsilObject, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${filename}')) # from line 144, col 6.
        write('''
''')
        for var in xsilObject.independentVariables: # generated from line 145, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${outName}')) # from line 149, col 1.
            write(""" = eval('_""")
            _v = VFFSL(SL,"objectNum",True)+1 # u'${objectNum+1}' on line 149, col 21
            if _v is not None: write(_filter(_v, rawExpr='${objectNum+1}')) # from line 149, col 21.
            write('''.''')
            _v = VFFSL(SL,"var.name",True) # u'${var.name}' on line 149, col 36
            if _v is not None: write(_filter(_v, rawExpr='${var.name}')) # from line 149, col 36.
            write("""');
""")
        for var in xsilObject.dependentVariables: # generated from line 151, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${outName}')) # from line 153, col 1.
            write(""" = eval('_""")
            _v = VFFSL(SL,"objectNum",True)+1 # u'${objectNum+1}' on line 153, col 21
            if _v is not None: write(_filter(_v, rawExpr='${objectNum+1}')) # from line 153, col 21.
            write('''.''')
            _v = VFFSL(SL,"var.name",True) # u'${var.name}' on line 153, col 36
            if _v is not None: write(_filter(_v, rawExpr='${var.name}')) # from line 153, col 36.
            write("""');
""")
            ...
            if _v is not None: write(_filter(_v, rawExpr='${permuteDimensionsOfMATLABVariable(outName)}')) # from line 154, col 1.
        write('''clear _''')
        _v = VFFSL(SL,"objectNum",True)+1 # u'${objectNum+1}' on line 156, col 8
        if _v is not None: write(_filter(_v, rawExpr='${objectNum+1}')) # from line 156, col 8.
        write(''';
''')
