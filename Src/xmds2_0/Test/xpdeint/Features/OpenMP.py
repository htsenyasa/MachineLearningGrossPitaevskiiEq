...
omp_set_num_threads(''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$threadCount')) # from line 45, col 21.
            write(''');
#endif
''')
        # 
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${suffix}')) # from line 77, col 53.
        write('''
#endif
''')
        # 
...
''')
        for vector in vectors: # generated from line 91, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 92, col 4.
            write('''_index_pointer = _i0 * _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 92, col 40
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 92, col 40.
            write('''_ncomponents;
''')
...
#pragma omp parallel for firstprivate(__initialised)''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${suffix}')) # from line 156, col 53.
        write('''
#endif
''')
        # 
...
''')
        for vector in vectorsNotRequiringExplicitIndexPointers: # generated from line 174, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 175, col 4.
            write('''_index_pointer = ''')
            _v = VFFSL(SL,"dimRep.loopIndex",True) # u'${dimRep.loopIndex}' on line 175, col 33
            if _v is not None: write(_filter(_v, rawExpr='${dimRep.loopIndex}')) # from line 175, col 33.
            write(''' * ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${vector.field.localPointsInDimensionsAfterDimRepInBasis(dimRep, basis)}')) # from line 175, col 55.
            write(''' * _''')
            _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 175, col 131
            if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 175, col 131.
            write('''_ncomponents;
''')
            for prefixDimRep in field.inBasis(basis): # generated from line 176, col 5
                ...
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 180, col 4.
                write('''_index_pointer += ''')
                _v = VFFSL(SL,"prefixDimRep.loopIndex",True) # u'${prefixDimRep.loopIndex}' on line 180, col 34
                if _v is not None: write(_filter(_v, rawExpr='${prefixDimRep.loopIndex}')) # from line 180, col 34.
                write(''' * ''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='${vector.field.localPointsInDimensionsAfterDimRepInBasis(prefixDimRep, basis)}')) # from line 180, col 62.
                write(''' * _''')
                _v = VFFSL(SL,"vector.id",True) # u'${vector.id}' on line 180, col 144
                if _v is not None: write(_filter(_v, rawExpr='${vector.id}')) # from line 180, col 144.
                write('''_ncomponents;
''')
        write('''  __initialised = true;
}
