...
''')
  ...
  for (long _i1 = 0; _i1 < ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${forwardDimRep.globalLattice}')) # from line 57, col 28.
        write('''; _i1++) {
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeatures('loopOverVectorsWithInnerContentTemplateBegin', featureOrdering, featureDict)}")) # from line 66, col 1.
      ...
      ptrdiff_t _index = (_i0 * ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${forwardDimRep.globalLattice}')) # from line 68, col 33.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${insertCodeForFeaturesInReverseOrder('loopOverVectorsWithInnerContentTemplateEnd', featureOrdering, featureDict)}")) # from line 77, col 1.
        # 
