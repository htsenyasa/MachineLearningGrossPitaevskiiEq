...
class FourierTransformFFTW3Threads(FourierTransformFFTW3):
    ...
    def defines(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${threadCount}')) # from line 31, col 22.
        write('''
''')
        # 
    ...
    def mainBegin(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${fftwPrefix}')) # from line 37, col 1.
        write('''_init_threads();
''')
        _v = VFFSL(SL,"fftwPrefix",True) # u'${fftwPrefix}' on line 38, col 1
        if _v is not None: write(_filter(_v, rawExpr='${fftwPrefix}')) # from line 38, col 1.
...
''')
    ...
    def mainEnd(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${fftwPrefix}')) # from line 45, col 1.
