...
#define _CHUNK_SIZE ((long)''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$chunkSize')) # from line 32, col 28.
        write(''')
''')
        # 
    ...
    def preAllocation(self, dict, **KWS):
        ...
        for mg in VFFSL(SL,"momentGroups",True): # generated from line 38, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localLattice}')) # from line 43, col 1.
            write(''' = ''')
            _v = VFFSL(SL,"propDimRep.globalLattice",True) # u'${propDimRep.globalLattice}' on line 43, col 30
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.globalLattice}')) # from line 43, col 30.
            write(''';
if (''')
            ...
            if _v is not None: write(_filter(_v, rawExpr="${mg.processedVector.sizeInBasis(mg.codeBlocks['sampling'].basis)}")) # from line 44, col 5.
            write(''')
  ''')
            _v = VFFSL(SL,"propDimRep.localLattice",True) # u'${propDimRep.localLattice}' on line 45, col 3
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localLattice}')) # from line 45, col 3.
            ...
            if _v is not None: write(_filter(_v, rawExpr="${mg.processedVector.sizeInBasis(mg.codeBlocks['sampling'].basis)}")) # from line 45, col 55.
            write(''' / ''')
            _v = VFFSL(SL,"propDimRep.globalLattice",True) # u'${propDimRep.globalLattice}' on line 45, col 124
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.globalLattice}')) # from line 45, col 124.
            write(''' * sizeof(''')
            _v = VFFSL(SL,"mg.processedVector.type",True) # u'${mg.processedVector.type}' on line 45, col 161
            if _v is not None: write(_filter(_v, rawExpr='${mg.processedVector.type}')) # from line 45, col 161.
            write(''')) + 1, ''')
            _v = VFFSL(SL,"propDimRep.globalLattice",True) # u'${propDimRep.globalLattice}' on line 45, col 195
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.globalLattice}')) # from line 45, col 195.
            write(''');
''')
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${insertCodeForFeatures('findMax', ['Driver'], {'variable': '&' + propDimRep.localLattice, 'count': 1, 'op': 'min', 'type': 'long'}), autoIndent=True}")) # from line 46, col 1.
            write('''// Now find the minimum and broadcast it.
''')
        #  Initialise output files
        outputFeature = VFFSL(SL,"features",True)['Output']
        _v = VFN(VFFSL(SL,"outputFeature.outputFormat",True),"writeOutSetup",False)(''.join(['("',str(VFFSL(SL,"outputFeature.filename",True)),'" + gsArgsAndValues).c_str()']), outputFeature) # u'${outputFeature.outputFormat.writeOutSetup(c\'("${outputFeature.filename}" + gsArgsAndValues).c_str()\', outputFeature)}' on line 51, col 1
        if _v is not None: write(_filter(_v, rawExpr='${outputFeature.outputFormat.writeOutSetup(c\'("${outputFeature.filename}" + gsArgsAndValues).c_str()\', outputFeature)}')) # from line 51, col 1.
        ...
        if _v is not None: write(_filter(_v, rawExpr='${outputFeature.outputFormat.writeOutTearDown}')) # from line 52, col 1.
        # 
    ...
    def sampleFunctionEnd(self, dict, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.index}')) # from line 64, col 5.
        write(''' == ''')
        _v = VFFSL(SL,"propDimRep.localLattice",True) # u'${propDimRep.localLattice}' on line 64, col 28
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localLattice}')) # from line 64, col 28.
        write('''
    && (''')
        _v = VFFSL(SL,"propDimRep.index",True) # u'${propDimRep.index}' on line 65, col 9
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.index}')) # from line 65, col 9.
        write(''' + ''')
        _v = VFFSL(SL,"propDimRep.localOffset",True) # u'${propDimRep.localOffset}' on line 65, col 31
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localOffset}')) # from line 65, col 31.
        write(''') != ''')
        _v = VFFSL(SL,"propDimRep.globalLattice",True) # u'${propDimRep.globalLattice}' on line 65, col 61
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.globalLattice}')) # from line 65, col 61.
        write(''')
{
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr="${mg.functions['writeOut'].call(_outfile='NULL'), autoIndent=True}")) # from line 67, col 3.
        write('''
  _LOG(_SIMULATION_LOG_LEVEL, "Written a chunk of moment group ''')
        _v = VFFSL(SL,"mg.number",True)+1 # u'${mg.number+1}' on line 68, col 64
        if _v is not None: write(_filter(_v, rawExpr='${mg.number+1}')) # from line 68, col 64.
        write('''\\n");
  ''')
        _v = VFFSL(SL,"propDimRep.localOffset",True) # u'${propDimRep.localOffset}' on line 69, col 3
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localOffset}')) # from line 69, col 3.
        write(''' += ''')
        _v = VFFSL(SL,"propDimRep.index",True) # u'${propDimRep.index}' on line 69, col 32
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.index}')) # from line 69, col 32.
        write(''';
  ''')
        _v = VFFSL(SL,"propDimRep.index",True) # u'${propDimRep.index}' on line 70, col 3
        if _v is not None: write(_filter(_v, rawExpr='${propDimRep.index}')) # from line 70, col 3.
        write(''' = 0;
''')
        if mg.integratingComponents: # generated from line 71, col 3
            ...
            if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${mg.rawVector.initialise, autoIndent=True}')) # from line 72, col 3.
        write('''}
''')
    ...
    def writeOutBegin(self, dict, **KWS):
        ...
        for mg in VFFSL(SL,"momentGroups",True): # generated from line 79, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.localLattice}')) # from line 84, col 1.
            write(''' = ''')
            _v = VFFSL(SL,"propDimRep.index",True) # u'${propDimRep.index}' on line 84, col 30
            if _v is not None: write(_filter(_v, rawExpr='${propDimRep.index}')) # from line 84, col 30.
            write(''';
''')
        # 
