...
class HermiteGaussDimensionRepresentation(NonUniformDimensionRepresentation):
    ...
    def gridAtIndex(self, index, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${parent.name}')) # from line 29, col 16.
        write('''[''')
        _v = VFFSL(SL,"index",True) # u'$index' on line 29, col 31
        if _v is not None: write(_filter(_v, rawExpr='$index')) # from line 29, col 31.
        write('''] * ''')
        _v = VFFSL(SL,"_maximum",True) # u'${_maximum}' on line 29, col 41
        if _v is not None: write(_filter(_v, rawExpr='${_maximum}')) # from line 29, col 41.
        write(''' / sqrt(''')
        _v = VFFSL(SL,"fieldCount",True) / 2.0 # u'${fieldCount / 2.0}' on line 29, col 60
        if _v is not None: write(_filter(_v, rawExpr='${fieldCount / 2.0}')) # from line 29, col 60.
        write(''')''')
        # 
    ...
    def stepWeightAtIndex(self, index, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${parent.name}')) # from line 35, col 24.
        write('''[''')
        _v = VFFSL(SL,"index",True) # u'$index' on line 35, col 39
        if _v is not None: write(_filter(_v, rawExpr='$index')) # from line 35, col 39.
        write('''] * ''')
        _v = VFFSL(SL,"_maximum",True) # u'${_maximum}' on line 35, col 49
        if _v is not None: write(_filter(_v, rawExpr='${_maximum}')) # from line 35, col 49.
        write(''' / sqrt(''')
        _v = VFFSL(SL,"fieldCount",True) / 2.0 # u'${fieldCount / 2.0}' on line 35, col 68
        if _v is not None: write(_filter(_v, rawExpr='${fieldCount / 2.0}')) # from line 35, col 68.
        write(''')''')
        # 
    ...
    def indexForSinglePointSample(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 42, col 1.
        write('''/2''')
        # 
    ...
    def createCoordinateVariableForSinglePointSample(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${type}')) # from line 48, col 1.
        write(''' ''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 48, col 9
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 48, col 9.
        write(''' = ''')
        _v = VFFSL(SL,"arrayName",True) # u'${arrayName}' on line 48, col 19
        if _v is not None: write(_filter(_v, rawExpr='${arrayName}')) # from line 48, col 19.
        write('''[''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 48, col 32
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 48, col 32.
        write('''/2];
#define d''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${stepSizeArrayName}')) # from line 49, col 19.
        write('''[''')
        _v = VFFSL(SL,"globalLattice",True) # u'${globalLattice}' on line 49, col 40
        if _v is not None: write(_filter(_v, rawExpr='${globalLattice}')) # from line 49, col 40.
        write('''/2]  * (''')
        _v = VFFSL(SL,"volumePrefactor",True) # u'${volumePrefactor}' on line 49, col 64
        if _v is not None: write(_filter(_v, rawExpr='${volumePrefactor}')) # from line 49, col 64.
        write('''))
''')
        # 
