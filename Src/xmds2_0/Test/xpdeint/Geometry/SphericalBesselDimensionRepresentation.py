...
''')
    ...
    def besselJFunctionCall(self, order, argument, **KWS):
        ...
        if VFFSL(SL,"order",True) in [0, 1, 2]: # generated from line 39, col 3
            ...
            if _v is not None: write(_filter(_v, rawExpr='${order}')) # from line 40, col 16.
            write('''(''')
            _v = VFFSL(SL,"argument",True) # u'$argument' on line 40, col 25
            if _v is not None: write(_filter(_v, rawExpr='$argument')) # from line 40, col 25.
            write(''')''')
        else: # generated from line 41, col 3
            write('''gsl_sf_bessel_jl(''')
            _v = VFFSL(SL,"order",True) # u'$order' on line 42, col 18
            if _v is not None: write(_filter(_v, rawExpr='$order')) # from line 42, col 18.
            write(''', ''')
            _v = VFFSL(SL,"argument",True) # u'$argument' on line 42, col 26
            if _v is not None: write(_filter(_v, rawExpr='$argument')) # from line 42, col 26.
            write(''')''')
    ...
    def stepWeightAtIndex(self, index, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${parent.name}')) # from line 48, col 48.
        write(''' * _besseljS_''')
        _v = VFFSL(SL,"parent.name",True) # u'${parent.name}' on line 48, col 75
        if _v is not None: write(_filter(_v, rawExpr='${parent.name}')) # from line 48, col 75.
        write(''' * _besseljS_''')
        _v = VFFSL(SL,"parent.name",True) # u'${parent.name}' on line 48, col 102
        if _v is not None: write(_filter(_v, rawExpr='${parent.name}')) # from line 48, col 102.
        write(''') * ''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 48, col 120
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 48, col 120.
        write('''_max * ''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 48, col 134
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 48, col 134.
        write('''_max * ''')
        _v = VFFSL(SL,"name",True) # u'${name}' on line 48, col 148
        if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 48, col 148.
        write('''_max''')
        # 
