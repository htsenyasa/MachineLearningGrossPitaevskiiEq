...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr="${noiseVector.functions['evaluate'].call(_step = '(_new_step * _old_step)/(_old_step - _new_step)')}")) # from line 36, col 1.
        write('''
...
''')
    ...
    def makeNoises(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr="${{'complex': 0.5, 'real': 1.0}[noiseVector.type]}")) # from line 58, col 19.
        write(''' / (''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.spatiallyIndependentVolumeElement}')) # from line 58, col 73.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${makeFixedVarianceNoises}')) # from line 64, col 1.
        # 
        ...
        if nonUniformDimReps: # generated from line 67, col 3
            ...
            for component in noiseVector.components: # generated from line 70, col 7
                ...
                if _v is not None: write(_filter(_v, rawExpr='${component}')) # from line 71, col 1.
                write(''' *= ''')
                _v = VFFSL(SL,"fixupString",True) # u'${fixupString}' on line 71, col 17
                if _v is not None: write(_filter(_v, rawExpr='${fixupString}')) # from line 71, col 17.
                write(''';
''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='${loopOverFieldInBasisWithVectorsAndInnerContent(noiseVector.field, noiseVector.initialBasis, [noiseVector], loopString)}')) # from line 74, col 1.
        # 
