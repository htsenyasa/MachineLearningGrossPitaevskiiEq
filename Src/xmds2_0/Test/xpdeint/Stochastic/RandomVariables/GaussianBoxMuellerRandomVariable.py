...
do {
  _v1 = ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generator.minusOneToOneRandomNumber}')) # from line 32, col 9.
        write(''';
  _v2 = ''')
        _v = VFFSL(SL,"generator.minusOneToOneRandomNumber",True) # u'${generator.minusOneToOneRandomNumber}' on line 33, col 9
        if _v is not None: write(_filter(_v, rawExpr='${generator.minusOneToOneRandomNumber}')) # from line 33, col 9.
        write(''';
...
for (ptrdiff_t _i0 = 0; _i0 < _evenNoises; _i0 += 2) {
  ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${boxMuellerAlgorithm, autoIndent=True}')) # from line 48, col 3.
        write('''  reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 49, col 35
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 49, col 35.
        write(''')[_i0 + 0] = _v1*_fac;
  reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 50, col 35
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 50, col 35.
...
if (_vector_size & 1) {
  ...
  if (_spareNoiseAvailable && _old_var == _var) {
    reinterpret_cast<real*>(_active_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 60, col 37.
    ...
    ''')
        ...
        if _v is not None: write(_filter(_v, autoIndent=True, rawExpr='${boxMuellerAlgorithm, autoIndent=True}')) # from line 63, col 5.
        write('''    reinterpret_cast<real*>(_active_''')
        _v = VFFSL(SL,"noiseVector.id",True) # u'${noiseVector.id}' on line 64, col 37
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 64, col 37.
