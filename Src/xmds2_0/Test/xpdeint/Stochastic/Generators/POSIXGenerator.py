...
''')
    ...
    def minusOneToOneRandomNumber(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='$generatorName')) # from line 40, col 45.
        write(''') - 1.0''')
    ...
    def zeroToOneRandomNumber(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 42, col 39.
        write(''')''')
  ...
  _active_''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${noiseVector.id}')) # from line 47, col 11.
        write('''[_i0] = erand48(''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 47, col 44
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 47, col 44.
        write(''');
}
''')
    ...
    def initialiseLocalSeeds(self, **KWS):
        ...
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 58, col 7.
        write(''', sizeof(''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 58, col 32
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 58, col 32.
        write('''));
for (unsigned long _i0=0; _i0<MIN(3, ''')
        _v = VFFSL(SL,"seedCount",True) # u'${seedCount}' on line 59, col 38
        if _v is not None: write(_filter(_v, rawExpr='${seedCount}')) # from line 59, col 38.
        write('''); _i0++)
  ''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 60, col 3
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 60, col 3.
        write('''[_i0] = (unsigned short)''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 60, col 43
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 60, col 43.
        write('''_local_seeds[_i0];

erand48(''')
        _v = VFFSL(SL,"generatorName",True) # u'${generatorName}' on line 62, col 9
        if _v is not None: write(_filter(_v, rawExpr='${generatorName}')) # from line 62, col 9.
        write(''');
''')
        # 
