...
parser.add_argument('--training-len',      type=int,             default=1500,                               help = 'Training len (default: 3500)')
...
parser.add_argument('--data-file',         type=str,             default="interaction/pot_dens-g-VARY-.dat",              help = 'data file to read (default = "potential.dat")')
parser.add_argument('--label-file',        type=str,             default="interaction/inter_params.dat",                 help = 'label file to read (default = "energy.dat")')
