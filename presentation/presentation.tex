...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
		\centering
        \includesvg[width=4.5cm]{potential-g-1-epoch-20-}
		\label{fig:a}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
		\centering
        \includesvg[width=4.5cm]{potential-g-1-epoch-40-}
		\label{fig:b}
    \end{subfigure}    
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=4.5cm]{potential-g-1-epoch-60-}
		\label{fig:c}
    \end{subfigure}
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includesvg[width=4.5cm]{potential-g-1-epoch-60-LOSS-}
		\label{fig:c}
    \end{subfigure}
